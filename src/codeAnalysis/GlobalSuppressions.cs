...
// The latest CommunityToolkit.Mvvm provides helpful proactive warnings for AOT-incompatible code. We'll suppress these warnings for now until we address all of them.
[assembly: SuppressMessage("CommunityToolkit.Mvvm.SourceGenerators.ObservablePropertyGenerator", "MVVMTK0045:Using [ObservableProperty] on fields is not AOT compatible for WinRT", Justification = "Updated MVVM toolkit package introduced this.", Scope = "namespaceanddescendants", Target = "AdvancedPaste")]
