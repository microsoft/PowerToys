...
[assembly: SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1649:File name should match first type name", Justification = "Interface and default implementation in single file", Scope = "type", Target = "~T:ManagedCommon.ISearchService`1")]
[assembly: SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:File may only contain a single type", Justification = "Implement all search thins in single file", Scope = "type", Target = "~T:ManagedCommon.CaseInsensitiveContainsAlgorithm`1")]
