...
namespace newplus
{
    ...
    public:
        ...
        void enter_rename_mode(const ComPtr<IUnknown> site_of_folder, const std::filesystem::path target_fullpath) const;

        std::filesystem::path path;

    private:
        static void rename_on_other_thread_workaround(const ComPtr<IUnknown> site_of_folder, const std::filesystem::path target_fullpath);
