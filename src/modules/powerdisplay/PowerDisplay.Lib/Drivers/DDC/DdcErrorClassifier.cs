...
/// <summary>
/// Classifies the Win32 error codes <c>GetVCPFeatureAndVCPFeatureReply</c> reports, so the probe
/// and the initializers agree on which failures are worth another I2C transaction and which are
/// the device's final answer. Constant names mirror <c>winerror.h</c> exactly.
/// </summary>
