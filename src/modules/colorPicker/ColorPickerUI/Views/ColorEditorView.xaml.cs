...
namespace ColorPicker.Views
{
    ...
    public partial class ColorEditorView : UserControl
    {
        ...
        private void HistoryColors_ItemClick(object sender, ModernWpf.Controls.ItemClickEventArgs e)
        {
            ...
            // More appropriate event would be SelectionChanged but we can not distinguish beetween user action and program action inside of it.
            SessionEventHelper.Event.PickedColorFromHistory = true;
        }
    }
}
