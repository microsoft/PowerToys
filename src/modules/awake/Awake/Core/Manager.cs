...
namespace Awake.Core
{
    ...
    public class Manager
    {
        ...
        public static Dictionary<string, int> GetDefaultTrayOptions()
        {
            ...
            {
                { string.Format(CultureInfo.InvariantCulture, System.Text.CompositeFormat.Parse(Resources.AWAKE_MINUTES), 30), 1800 },
                { Resources.AWAKE_1_HOUR, 3600 },
                { string.Format(CultureInfo.InvariantCulture, System.Text.CompositeFormat.Parse(Resources.AWAKE_HOURS), 2), 7200 },
            };
            return optionsList;
        }
    }
