...
class __declspec(uuid("5E785611-FE77-4DC3-89AE-6A055F2ED053")) HopperContextMenuCommand final : public RuntimeClass<RuntimeClassFlags<ClassicCom>, IExplorerCommand, IObjectWithSite>
{
public:
    virtual const wchar_t* Title() { return L"PowerToys Hopper"; }
    ...
    {
        return SHStrDup(L"PowerToys Hopper", name);
    }
...
private:
    ...
    HRESULT ResizePictures(IShellItemArray* psiItemArray)
    {
        ...
        std::wstring pipe_name(L"\\\\.\\pipe\\powertoys_hopperinput_");
        UUID temp_uuid;
        ...
        create_pipe_thread = std::thread(&HopperContextMenuCommand::StartNamedPipeServerAndSendData, this, pipe_name);
    ...
    std::wstring app_name = L"PowerToys Hopper";
};

CoCreatableClass(HopperContextMenuCommand)
    CoCreatableClassWrlCreatorMapInclude(HopperContextMenuCommand)
