...
namespace Hosts.UITests
{
    ...
    public class HostModuleTests : UITestBase
    {
        ...
        public void TestEmptyView()
        {
            ...
            Assert.IsTrue(FindAll<Button>(By.Name("Delete")).Count == 1, "Should have one row now");
        ...
        public void TestAddingEntry()
        {
            ...
            Assert.IsTrue(FindAll<Button>(By.Name("Delete")).Count == 0, "Should have no row after removing all");
