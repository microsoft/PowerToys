...
#include <launcher\Microsoft.PowerToys.Run\LauncherConstants.h>
    ...
    virtual void enable()
    {
        ...
        if (UseNewSettings())
        {
            ...
            if (!is_process_elevated(false))
            {
                ...
                sei.lpFile = L"modules\\launcher\\Microsoft.PowerToys.Run.UI.exe";
            ...
            else
            {
                ...
                params += L"-target modules\\launcher\\Microsoft.PowerToys.Run.UI.exe ";
                params += L"-pidFile ";
