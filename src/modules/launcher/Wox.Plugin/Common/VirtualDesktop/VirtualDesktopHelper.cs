...
namespace Wox.Plugin.Common.VirtualDesktop.Helper
{
    ...
    public class VirtualDesktopHelper
    {
        ...
        public string GetDesktopName(Guid desktop)
        {
            ...
            var defaultName = string.Format(System.Globalization.CultureInfo.InvariantCulture, System.Text.CompositeFormat.Parse(Resources.VirtualDesktopHelper_Desktop), GetDesktopNumber(desktop));
