...
using Microsoft.Plugin.System.Components;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace Microsoft.Plugin.System.UnitTests
{
    [TestClass]
    public class PluginSettingsTests
    {
        ...
        {
            // Setup
            PropertyInfo[] settings = SystemPluginSettings.Instance?.GetType()?.GetProperties(BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        {
            // Setup
            Type settings = SystemPluginSettings.Instance?.GetType();
        ...
        {
            // Setup
            WindowWalkerSettings setting = SystemPluginSettings.Instance;
