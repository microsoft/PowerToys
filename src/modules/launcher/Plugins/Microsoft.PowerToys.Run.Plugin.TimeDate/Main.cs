...
namespace Microsoft.PowerToys.Run.Plugin.TimeDate
{
    public class Main : IPlugin, IPluginI18n, ISettingProvider, IContextMenu
    {
        ...
        public string GetTranslatedPluginDescription()
        {
            ...
            string timeExample = Resources.Microsoft_plugin_timedate_plugin_description_example_time + "::" + DateTime.MinValue.AddDays(686219).ToString("T", CultureInfo.CurrentCulture);
            string dayExample = Resources.Microsoft_plugin_timedate_plugin_description_example_day + "::" + DateTime.MinValue.AddDays(686219).ToString("d", CultureInfo.CurrentCulture);
            string calendarWeekExample = Resources.Microsoft_plugin_timedate_plugin_description_example_calendarWeek + "::" + DateTime.MinValue.AddDays(686219).ToString("d", CultureInfo.CurrentCulture);
