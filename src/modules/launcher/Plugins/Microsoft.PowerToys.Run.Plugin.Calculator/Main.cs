    ...
    public class Main : IPlugin, IPluginI18n, IDisposable, ISettingProvider
    {
        ...
        public IEnumerable<PluginAdditionalOption> AdditionalOptions => new List<PluginAdditionalOption>()
        {
            ...
            new PluginAdditionalOption()
            {
                ...
                DisplayDescription = string.Format(CultureInfo.CurrentCulture, System.Text.CompositeFormat.Parse(Resources.wox_plugin_calculator_in_en_format_description), 1000.55.ToString("N2", new CultureInfo("en-us"))),
                Value = false,
            },
            new PluginAdditionalOption()
            {
                ...
                DisplayDescription = string.Format(CultureInfo.CurrentCulture, System.Text.CompositeFormat.Parse(Resources.wox_plugin_calculator_out_en_format_description), 1000.55.ToString("G", new CultureInfo("en-us"))),
                Value = false,
            },
        };
