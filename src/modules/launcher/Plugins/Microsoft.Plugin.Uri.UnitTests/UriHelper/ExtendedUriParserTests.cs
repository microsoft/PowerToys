...
namespace Microsoft.Plugin.Uri.UnitTests.UriHelper
{
    ...
    public class ExtendedUriParserTests
    {
        ...
        [DataRow("mailto:/", false, null)]
        [DataRow("ms-settings:", true, "ms-settings:")]
        [DataRow("ms-settings:/", false, null)]
        [DataRow("ms-settings://", false, null)]
        [DataRow("ms-settings://privacy", true, "ms-settings://privacy/")]
        [DataRow("ms-settings://privacy/", true, "ms-settings://privacy/")]
        [DataRow("ms-settings:privacy", true, "ms-settings:privacy")]
        ...
        [DataRow("microsoft-edge:google.com/", true, "microsoft-edge:google.com/")]
        [DataRow("microsoft-edge:https://google.com/", true, "microsoft-edge:https://google.com/")]
        [DataRow("ftp://user:password@localhost:8080", true, "ftp://user:password@localhost:8080/")]
        [DataRow("ftp://user:password@localhost:8080/", true, "ftp://user:password@localhost:8080/")]
        [DataRow("ftp://user:password@google.com", true, "ftp://user:password@google.com/")]
        [DataRow("ftp://user:password@google.com:2121", true, "ftp://user:password@google.com:2121/")]
        [DataRow("ftp://user:password@1.1.1.1", true, "ftp://user:password@1.1.1.1/")]
        [DataRow("ftp://user:password@1.1.1.1:2121", true, "ftp://user:password@1.1.1.1:2121/")]
