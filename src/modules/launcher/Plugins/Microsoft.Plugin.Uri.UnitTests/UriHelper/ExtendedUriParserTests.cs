...
namespace Microsoft.Plugin.Uri.UnitTests.UriHelper
{
    ...
    public class ExtendedUriParserTests
    {
        ...
        [DataRow("[2001:0DB8::1]:80", true, "https://[2001:db8::1]:80/", true)]
        ...
        [DataRow("tel:411", true, "https://tel:411/", true)]
        [DataRow("tel:411/test", true, "https://tel:411/test", true)]
        [DataRow("tel:411/126", true, "https://tel:411/126", true)]
