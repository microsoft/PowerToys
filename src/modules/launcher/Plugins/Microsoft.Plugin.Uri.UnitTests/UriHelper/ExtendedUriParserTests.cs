...
namespace Microsoft.Plugin.Uri.UnitTests.UriHelper
{
    ...
    public class ExtendedUriParserTests
    {
        ...
        [DataRow("http://127.0.0.1:123/test", true, "http://127.0.0.1:123/test", true, null)]
        [DataRow("http://127.0.0.1/126", true, "http://127.0.0.1/126", true, null)]
        [DataRow("http://127.0.0.1:80", true, "http://127.0.0.1/", true, null)]
        ...
        [DataRow("tel:411/test", true, "https://tel:411/test", true, "tel:411/test")]
        [DataRow("tel:411/126", true, "https://tel:411/126", true, "tel:411/126")]
        [DataRow("local:1234", true, "https://local:1234/", true, "local:1234")]
        [DataRow("local:1234/test", true, "https://local:1234/test", true, "local:1234/test")]
        [DataRow("local:1234/126", true, "https://local:1234/126", true, "local:1234/126")]
