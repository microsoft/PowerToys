...
namespace Microsoft.Plugin.Folder.UnitTests
{
    ...
    public class InternalQueryFolderTests
    {
        ...
        [DataRow(@"c:\not-exist", 0, 0, false, DisplayName = "Folder not exist, return root")]
        ...
        [DataRow(@"c:\Test>", 0, 0, true, DisplayName = "2 Folders recursive")]
        [DataRow(@"c:\not-exist>", 0, 0, true, DisplayName = "Folder not exist, return root recursive")]
