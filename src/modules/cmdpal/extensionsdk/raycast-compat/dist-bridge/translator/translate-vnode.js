...
// ══════════════════════════════════════════════════════════════════════════
function translateGridItem(node, section) {
    const item = new RaycastListItem();
    item.title = node.props.title ?? '';
    item.subtitle = node.props.subtitle ?? '';
    ...
    if (content?.source) {
        const data = { icon: content.source };
 ...
 */
function inferGridLayout(columns) {
...
function translateGrid(node) {
    ...
    page.name = node.props.navigationTitle ?? '';
    page.placeholderText = node.props.searchBarPlaceholder ?? '';
    page.gridProperties = inferGridLayout(node.props.columns);
    return page;
}
// ══════════════════════════════════════════════════════════════════════════
// Detail translation
