        ...
        return [
            ...
            new ListItem(new NoOpCommand())
            {
                ...
                Details = new Details()
                {
                    ...
                    HeroImage = new IconInfo("https://m.media-amazon.com/images/M/MV5BNDBkMzVmNGQtYTM2OC00OWRjLTk5OWMtNzNkMDI4NjFjNTZmXkEyXkFqcGdeQXZ3ZXNsZXk@._V1_QL75_UX500_CR0,0,500,281_.jpg"), // #no-spell-check
