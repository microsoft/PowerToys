...
public partial class ListViewModel : PageViewModel, IDisposable
{
    ...
    {
        //// TODO: Just temp testing, need to think about where we want to filter, as AdvancedCollectionView in View could be done, but then grouping need CVS, maybe we do grouping in view
