...
public sealed partial class DockControl : UserControl, IRecipient<CloseContextMenuMessage>, IRecipient<EnterEditModeMessage>, IRecipient<ExitEditModeMessage>, IRecipient<CrossMonitorBandDropMessage>
{
