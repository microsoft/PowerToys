...
public partial class AdaptiveSettingsToggleInputElement : IAdaptiveInputElement, IAdaptiveCardElement
{
    public const string CustomInputType = "SettingsCard.Input.Toggle";
...
public partial class AdaptiveSettingsToggleInputParser : IAdaptiveElementParser
{
...
public class ToggleSwitchWithValue : IAdaptiveInputValue
{
    ...
    public ToggleSwitchWithValue(AdaptiveSettingsToggleInputElement element, SettingsCard card)
    {
...
public class AdaptiveSettingsToggleInputElementRenderer : IAdaptiveElementRenderer
{
    public UIElement Render(IAdaptiveCardElement element, AdaptiveRenderContext context, AdaptiveRenderArgs renderArgs)
    {
        ...
        if (item != null)
        {
            context.AddInputValue(new ToggleSwitchWithValue(item, settingsCard), renderArgs);
        }
