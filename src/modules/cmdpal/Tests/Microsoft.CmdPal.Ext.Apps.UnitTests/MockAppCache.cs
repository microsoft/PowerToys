...
public class MockAppCache : IAppCache
{
    ...
    /// </summary>
    public void TriggerReload() => _shouldReload = true;
    ...
    /// <summary>
    /// Removes a Win32 program from the cache.
    /// </summary>
    /// <param name="program">The Win32 program to remove.</param>
    public void RemoveWin32Program(Win32Program program)
    {
        if (_win32s.Remove(program))
        {
            TriggerReload();
        }
    }
    ...
    /// <summary>
    /// Removes a UWP application from the cache.
    /// </summary>
    /// <param name="app">The UWP application to remove.</param>
    public void RemoveUWPApplication(IUWPApplication app)
    {
        if (_uwps.Remove(app))
        {
            TriggerReload();
