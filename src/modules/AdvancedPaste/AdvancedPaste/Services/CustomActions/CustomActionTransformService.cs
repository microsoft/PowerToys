...
namespace AdvancedPaste.Services.CustomActions
{
    public sealed class CustomActionTransformService : ICustomActionTransformService
    {
        ...
        public CustomActionTransformService(IPromptModerationService promptModerationService, IPasteAIProviderFactory providerFactory)
        {
            ...
            try
            {
                ...
                var providerResult = await provider.ProcessPasteAsync(
                    new PasteAIRequest
                    {
                        ...
                        KernelFactory = context.KernelFactory,
                ...
                Logger.LogDebug($"{nameof(CustomActionTransformService)}.{nameof(TransformAsync)} complete; ModelName={modelName ?? ""}, PromptTokens={usage.PromptTokens}, CompletionTokens={usage.CompletionTokens}");
