...
/// <summary>
/// Dynamic credentials provider that resolves credentials based on the current Paste AI configuration.
/// </summary>
public sealed class DynamicPasteAICredentialsProvider : IPasteAICredentialsProvider
{
    ...
    public DynamicPasteAICredentialsProvider(IUserSettings userSettings)
    {
    ...
    private bool UpdateProvider(bool force = false)
    {
        ...
        string normalizedServiceType = NormalizeServiceType(pasteConfig.ServiceType);
        bool useShared = pasteConfig.UseSharedCredentials;
        ...
        _currentProvider = CreateProvider(pasteConfig, normalizedServiceType, useShared);
        _currentServiceType = normalizedServiceType;
        _useSharedCredentials = useShared;
        return true;
    }

    private static IAICredentialsProvider CreateProvider(PasteAIConfiguration config, string normalizedServiceType, bool useShared)
    {
