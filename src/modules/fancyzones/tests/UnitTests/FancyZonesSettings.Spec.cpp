...
namespace FancyZonesUnitTests
{
    ...
    void compareSettings(const Settings& expected, const Settings& actual)
    {
        ...
        Assert::AreEqual(expected.multiMonitorMode, actual.multiMonitorMode);
        ...
        TEST_METHOD_INITIALIZE(Init)
            ...
            TEST_METHOD_CLEANUP(Cleanup)
                ...
                TEST_METHOD (Create)
                {
                    ...
                    values.add_property(L"fancyzones_multi_monitor_mode", expected.multiMonitorMode);
                ...
                TEST_METHOD (CreateWithBoolValuesMissed)
                {
                    const Settings expected{
                        ...
                        .multiMonitorMode = m_defaultSettings.multiMonitorMode,
        ...
        TEST_METHOD_INITIALIZE(Init)
            {
                ...
                m_ptSettings->add_bool_toggle(L"fancyzones_multi_monitor_mode", IDS_SETTING_DESCRIPTION_MULTI_MONITOR_MODE, expected.multiMonitorMode);
