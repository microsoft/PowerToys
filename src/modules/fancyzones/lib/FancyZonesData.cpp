...
{
    JSONHelpers::EditorArgsJSON argsJson; /* json arguments */
    ...
    for (auto& monitorData : allMonitors)
    {
        ...
        JSONHelpers::MonitorJSON monitorJson;
    ...
    json::to_file(editorParametersFileName, JSONHelpers::EditorArgsJSON::ToJson(argsJson));
}
