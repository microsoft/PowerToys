...
{
    internal sealed class CRC64Decimal(Hashes.Hashes.HashCallingAction hashCallingAction) : IActionAndRequestCheckedMenuItems
    {
        ...
        public async Task Execute(object sender, RoutedEventArgs e)
        {
            ...
            {
                await Hashes.Hashes.GenerateHashes(Hashes.Hashes.HashType.CRC64Decimal, SelectedItems, CheckedMenuItemsDictionary);
            }
            else
            {
                await Hashes.Hashes.VerifyHashes(Hashes.Hashes.HashType.CRC64Decimal, SelectedItems, CheckedMenuItemsDictionary);
            }
        }
    }
}
