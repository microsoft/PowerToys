...
namespace PowerToys.FileActionsMenu.Plugins.Hashes
{
    internal sealed class MultipleFiles(Hashes.HashCallingAction hashCallingAction) : ICheckableAction
    {
        ...
        public override string Title => hashCallingAction == Hashes.HashCallingAction.GENERATE ? "Save in multiple files" : "Compare checksum with content of same named files";
