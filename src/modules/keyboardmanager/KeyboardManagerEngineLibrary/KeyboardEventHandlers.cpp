...
namespace KeyboardEventHandlers
{
    ...
    */
    ...
    {
        // Without any app-specific remap there is nothing to match the foreground process
        // against, so skip resolving it. That lookup is the most expensive work done per key
        // event and the vast majority of users configure no app-specific remap at all.
        if (state.appSpecificShortcutReMap.empty())
        {
            return 0;
        }
