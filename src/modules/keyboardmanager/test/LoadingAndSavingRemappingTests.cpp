...
namespace RemappingUITests
{
    ...
    public:
        ...
        TEST_METHOD (CheckIfRemappingsAreValid_ShouldReturnRemapUnsuccessful_OnPassingAppSpecificRemapsWithSameShortcutRemappedTwiceForTheSameTargetApp)
        {
            ...
            dest1.SetKey(VK_CONTROL);
            dest1.SetKey(0x56);
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src1, 0x42 }), testApp1));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src1, dest1 }), testApp1));
        ...
        TEST_METHOD (CheckIfRemappingsAreValid_ShouldReturnNoError_OnPassingAppSpecificRemapsWithSameShortcutRemappedTwiceForDifferentTargetApps)
        {
            ...
            dest1.SetKey(0x56);
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src1, 0x42 }), testApp1));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src1, dest1 }), testApp2));
        ...
        TEST_METHOD (ApplySingleKeyRemappings_ShouldCopyOnlyValidRemappings_OnPassingBufferWithSomeInvalidRemappings)
        {
            ...
            s2.SetKey(VK_LMENU);
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ 0x41, 0x42 }), std::wstring()));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ 0x42, s1 }), std::wstring()));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ 0x43, NULL }), std::wstring()));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ 0x44, s2 }), std::wstring()));
        ...
        TEST_METHOD (ApplySingleKeyRemappings_ShouldSplitRemappingsFromCommonModifiers_OnPassingBufferWithSomeMappingsFromCommonModifiers)
        {
            ...
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ VK_CONTROL, 0x41 }), std::wstring()));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ VK_MENU, 0x42 }), std::wstring()));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ VK_SHIFT, 0x43 }), std::wstring()));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ CommonSharedConstants::VK_WIN_BOTH, 0x44 }), std::wstring()));
        ...
        TEST_METHOD (ApplyShortcutRemappings_ShouldCopyOnlyValidRemappings_OnPassingBufferWithSomeInvalidRemappings)
        {
            ...
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src1, dest1 }), std::wstring()));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src2, dest2 }), std::wstring()));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src3, NULL }), std::wstring()));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src4, dest4 }), std::wstring()));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src3, dest2 }), testApp1));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src4, dest1 }), testApp1));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src1, NULL }), testApp1));
            remapBuffer.push_back(std::make_pair(std::vector<std::variant<DWORD, Shortcut>>({ src2, dest4 }), testApp1));
