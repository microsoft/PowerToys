    ...
    public:
        TEST_METHOD_INITIALIZE(InitializeTestEnv)
            ...
            TEST_METHOD (ValidateAndUpdateKeyBufferElement_ShouldUpdateAndReturnNoError_OnSettingKeyToNonNullInAValidKeyToShortcutRow)
            {
                ...
                RemapBuffer remapBuffer{
                    { { VK_NULL, Shortcut(std::vector<int32_t>{ VK_CONTROL, 0x41 }) } },
                };
            ...
            // Test if the ValidateAndUpdateKeyBufferElement method is successful when setting first column of a key to key row to the same value as in another row
            TEST_METHOD (ValidateAndUpdateKeyBufferElement_ShouldReturnNoError_OnSettingFirstColumnOfAKeyToKeyRowToSameValueAsInAnotherRow)
            {
                ...
                // Assert that the element is invalid and buffer is not updated
                Assert::AreEqual(ShortcutErrorType::NoError, error);
                Assert::AreEqual(VK_A, std::get<DWORD>(remapBuffer[1].mapping[0]));
                Assert::AreEqual(VK_C, std::get<DWORD>(remapBuffer[1].mapping[1]));
            }

            // Test if the ValidateAndUpdateKeyBufferElement method is successful when setting first column of a key to shortcut row to the same value as in another row
            TEST_METHOD (ValidateAndUpdateKeyBufferElement_ShouldReturnNoError_OnSettingFirstColumnOfAKeyToShortcutRowToSameValueAsInAnotherRow)
            {
                // Add a row from A->B and a row with Ctrl+A as target
                RemapBuffer remapBuffer{
                    { { VK_A, VK_B } },
                    { { VK_NULL, Shortcut(std::vector<int32_t>{ VK_CONTROL, VK_A }) } },
                };
            ...
            // Test if the ValidateAndUpdateKeyBufferElement method is successful when setting first column of a key to key row to a conflicting modifier with another row
            TEST_METHOD (ValidateAndUpdateKeyBufferElement_ShouldReturnNoError_OnSettingFirstColumnOfAKeyToKeyRowToConflictingModifierWithAnotherRow)
            {
                ...
                // Assert that the element is invalid and buffer is not updated
                Assert::AreEqual(ShortcutErrorType::NoError, error);
                Assert::AreEqual(VK_LCONTROL, std::get<DWORD>(remapBuffer[1].mapping[0]));
                Assert::AreEqual(VK_C, std::get<DWORD>(remapBuffer[1].mapping[1]));
            }

            // Test if the ValidateAndUpdateKeyBufferElement method is successful when setting first column of a key to shortcut row to a conflicting modifier with another row
            TEST_METHOD (ValidateAndUpdateKeyBufferElement_ShouldReturnNoError_OnSettingFirstColumnOfAKeyToShortcutRowToConflictingModifierWithAnotherRow)
            {
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoErrorAndNoAction_OnSettingColumnToNullInANewOrValidRow)
            {
                std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 0, std::vector<int32_t>({ -1, 0x43 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x41 } } } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>({ -1, 0x41 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x41 } } } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>({ -1, 0x41 }), std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x41 } } } },
                    ...
                    { 0, 0, 1, std::vector<int32_t>({ VK_CONTROL, -1 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x41 } } } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>({ VK_CONTROL, -1 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x41 } } } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>({ VK_CONTROL, -1 }), std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x41 } } } },
                    ...
                    { 0, 0, 0, std::vector<int32_t>({ -1, VK_SHIFT, 0x44 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } } } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>({ -1, VK_SHIFT, 0x42 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } } } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>({ -1, VK_SHIFT, 0x42 }), std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } } } },
                    ...
                    { 0, 0, 1, std::vector<int32_t>({ VK_CONTROL, -1, 0x44 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } } } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>({ VK_CONTROL, -1, 0x42 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } } } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>({ VK_CONTROL, -1, 0x42 }), std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } } } },
                    ...
                    { 0, 0, 2, std::vector<int32_t>({ VK_CONTROL, VK_SHIFT, -1 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } } } },
                    ...
                    { 0, 1, 2, std::vector<int32_t>({ VK_CONTROL, VK_SHIFT, -1 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } } } },
                    ...
                    { 0, 1, 2, std::vector<int32_t>({ VK_CONTROL, VK_SHIFT, -1 }), std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } } } },
                    ...
                    { 0, 0, 3, std::vector<int32_t>({ VK_CONTROL, VK_SHIFT, VK_MENU, -1 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, 0x42 } } } },
                    ...
                    { 0, 1, 3, std::vector<int32_t>({ VK_CONTROL, VK_SHIFT, VK_MENU, -1 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, 0x42 } } } },
                    ...
                    { 0, 1, 3, std::vector<int32_t>({ VK_CONTROL, VK_SHIFT, VK_MENU, -1 }), std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, 0x42 } } } },
                    ...
                    { 0, 0, 3, std::vector<int32_t>({ VK_CONTROL, VK_SHIFT, VK_MENU, VK_LWIN, -1 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, VK_LWIN, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, VK_LWIN, 0x42 } } } },
                    ...
                    { 0, 1, 3, std::vector<int32_t>({ VK_CONTROL, VK_SHIFT, VK_MENU, VK_LWIN, -1 }), std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, VK_LWIN, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, VK_LWIN, 0x42 } } } },
                    ...
                    { 0, 1, 3, std::vector<int32_t>({ VK_CONTROL, VK_SHIFT, VK_MENU, VK_LWIN, -1 }), std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, VK_LWIN, 0x44 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, VK_MENU, VK_LWIN, 0x42 } } } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutStartWithModifierErrorAndNoAction_OnSettingFirstDropDownToActionKeyOnANonHybridColumn)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 0, std::vector<int32_t>{ 0x41 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 2: Validate the element when selecting A (0x41) on first dropdown of second column of empty shortcut to shortcut row
                    { 0, 1, 0, std::vector<int32_t>{ 0x41 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 3: Validate the element when selecting A (0x41) on first dropdown of first column of empty shortcut to key row
                    { 0, 0, 0, std::vector<int32_t>{ 0x41 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), VK_NULL }, std::wstring(), RemapCondition::Always } },
                    // Case 4: Validate the element when selecting A (0x41) on first dropdown of first column of valid shortcut to shortcut row
                    { 0, 0, 0, std::vector<int32_t>{ 0x41, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x41 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoErrorAndNoAction_OnSettingFirstDropDownToActionKeyOnAnEmptyHybridColumn)
            {
                std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0x41 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 2: Validate the element when selecting A (0x41) on first dropdown of second column of empty shortcut to key row
                    { 0, 1, 0, std::vector<int32_t>{ 0x41 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), VK_NULL }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutNotMoreThanOneActionKeyAndNoAction_OnSettingNonLastDropDownToActionKeyOnAHybridColumnWithFullShortcut)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0x41, 0x43 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 2: Validate the element when selecting A (0x41) on second dropdown of second column of hybrid shortcut to shortcut row
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x41, 0x42 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutNotMoreThanOneActionKeyAndNoAction_OnSettingNonFirstNonLastDropDownToActionKeyOnANonHybridColumnWithFullShortcut)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0x41, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    // Case 2: Validate the element when selecting A  (0x41)on second dropdown of second column of shortcut to shortcut row
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x41, 0x42 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoErrorAndNoAction_OnSettingLastDropDownToActionKeyOnAColumnWithAtleastTwoDropDowns)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 2, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x41 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 2, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x41 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 2, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x41 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    // Case 4: Validate the element when selecting A (0x41) on last dropdown of first column of two key shortcut to shortcut row
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0x41 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    // Case 5: Validate the element when selecting A (0x41) on last dropdown of second column of two key shortcut to shortcut row
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x41 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x41 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoErrorAndClearUnusedDropDownsAction_OnSettingNonFirstDropDownToActionKeyOnAColumnIfAllTheDropDownsAfterItAreEmpty)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0x41, -1 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x41, -1 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x41, -1 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ -1, 0x41, -1 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ -1, 0x41, -1 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ -1, 0x41, -1 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoErrorAndClearUnusedDropDownsAction_OnSettingFirstDropDownToActionKeyOnAHybridColumnIfAllTheDropDownsAfterItAreEmpty)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0x41, -1, -1 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoErrorAndAddDropDownAction_OnSettingLastDropDownToNonRepeatedModifierKeyOnAColumnIfThereAreLessThan3DropDowns)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 0, std::vector<int32_t>{ VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ VK_SHIFT }, std::wstring(), true, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ VK_SHIFT }, std::wstring(), true, { RemapBufferItem{ Shortcut(), (DWORD)0x44 }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutCannotHaveRepeatedModifierErrorAndNoAction_OnSettingLastDropDownToRepeatedModifierKeyOnAColumnIfThereAreLessThan3DropDowns)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, VK_LCONTROL }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_LCONTROL }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_LCONTROL }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutMaxShortcutSizeOneActionKeyErrorAndNoAction_OnSettingLastDropDownToNonRepeatedModifierKeyOnAColumnIfThereAre3OrMoreDropDowns)
            {
                ...
                testCases.push_back({ 0, 0, 4, { VK_CONTROL, -1, -1, -1, VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } } } });
                ...
                testCases.push_back({ 0, 1, 4, { VK_CONTROL, -1, -1, -1, VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } } } });
                ...
                testCases.push_back({ 0, 1, 4, { VK_CONTROL, -1, -1, -1, VK_SHIFT }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } } } });
                ...
                testCases.push_back({ 0, 0, 4, { -1, -1, -1, -1, VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() } } });
                ...
                testCases.push_back({ 0, 1, 4, { -1, -1, -1, -1, VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() } } });
                ...
                testCases.push_back({ 0, 1, 4, { -1, -1, -1, -1, VK_SHIFT }, std::wstring(), true, { RemapBufferItem{ Shortcut(), Shortcut() } } });
                ...
                testCases.push_back({ 0, 0, 4, { VK_CONTROL, VK_MENU, VK_LWIN, VK_RWIN, VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_RWIN, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_RWIN, 0x42 } } } });
                ...
                testCases.push_back({ 0, 1, 4, { VK_CONTROL, VK_MENU, VK_LWIN, VK_RWIN, VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_RWIN, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_RWIN, 0x42 } } } });
                ...
                testCases.push_back({ 0, 1, 4, { VK_CONTROL, VK_MENU, VK_LWIN, VK_RWIN, VK_SHIFT }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_RWIN, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_RWIN, 0x42 } } } });
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutMaxShortcutSizeOneActionKeyErrorAndNoAction_OnSettingLastDropDownToRepeatedModifierKeyOnAColumnIfThereAre3OrMoreDropDowns)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 4, std::vector<int32_t>{ VK_CONTROL, -1, -1, -1, VK_CONTROL }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } } } },
                    ...
                    { 0, 1, 4, std::vector<int32_t>{ VK_CONTROL, -1, -1, -1, VK_CONTROL }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } } } },
                    ...
                    { 0, 1, 4, std::vector<int32_t>{ VK_CONTROL, -1, -1, -1, VK_CONTROL }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } } } },
                    ...
                    { 0, 0, 4, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_SHIFT, VK_CONTROL }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_SHIFT, 0x42 } } } },
                    ...
                    { 0, 1, 4, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_SHIFT, VK_CONTROL }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_SHIFT, 0x42 } } } },
                    ...
                    { 0, 1, 4, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_SHIFT, VK_CONTROL }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_LWIN, VK_SHIFT, 0x42 } } } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoErrorAndNoAction_OnSettingNonLastDropDownToNonRepeatedModifierKeyOnAColumn)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 0, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 0, std::vector<int32_t>{ VK_SHIFT, VK_MENU, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ VK_SHIFT, VK_MENU, 0x42 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ VK_SHIFT, VK_MENU, 0x42 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x42 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutCannotHaveRepeatedModifierErrorAndNoAction_OnSettingNonLastDropDownToRepeatedModifierKeyOnAColumn)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 0, std::vector<int32_t>{ VK_CONTROL, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ VK_CONTROL, VK_CONTROL, 0x42 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ VK_CONTROL, VK_CONTROL, 0x42 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 0, std::vector<int32_t>{ VK_MENU, VK_MENU, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ VK_MENU, VK_MENU, 0x42 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ VK_MENU, VK_MENU, 0x42 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_CONTROL, 0x42 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_CONTROL, 0x42 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutStartWithModifierErrorAndNoAction_OnSettingFirstDropDownToNoneOnNonHybridColumnWithOneDropDown)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 0, std::vector<int32_t>{ 0 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutOneActionKeyErrorAndNoAction_OnSettingFirstDropDownToNoneOnHybridColumnWithOneDropDown)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutAtleast2KeysAndNoAction_OnSettingFirstDropDownToNoneOnNonHybridColumnWithTwoDropDowns)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 0, std::vector<int32_t>{ 0, -1 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0, -1 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 0, std::vector<int32_t>{ 0, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0, 0x42 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutOneActionKeyAndNoAction_OnSettingSecondDropDownToNoneOnNonHybridColumnWithTwoDropDowns)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ -1, 0 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ -1, 0 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoErrorAndDeleteDropDownAction_OnSettingDropDownToNoneOnHybridColumnWithTwoDropDowns)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0, -1 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ -1, 0 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0, VK_CONTROL }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x42 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoErrorAndDeleteDropDownAction_OnSettingNonLastDropDownToNoneOnColumnWithThreeDropDowns)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 0, std::vector<int32_t>{ 0, -1, -1 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0, -1, -1 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0, -1, -1 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ -1, 0, -1 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ -1, 0, -1 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ -1, 0, -1 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 0, std::vector<int32_t>{ 0, VK_MENU, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0, VK_MENU, 0x42 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0, VK_MENU, 0x42 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0, 0x42 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0, 0x42 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnShortcutOneActionKeyErrorAndNoAction_OnSettingLastDropDownToNoneOnColumnWithThreeDropDowns)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    // Case 1: Validate the element when selecting None (0) on first dropdown of first column of 3 dropdown empty shortcut to shortcut row
                    { 0, 0, 2, std::vector<int32_t>{ -1, -1, 0 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 2: Validate the element when selecting None (0) on first dropdown of second column of 3 dropdown empty shortcut to shortcut row
                    { 0, 1, 2, std::vector<int32_t>{ -1, -1, 0 }, std::wstring(), false, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 3: Validate the element when selecting None (0) on first dropdown of second column of 3 dropdown empty hybrid shortcut to shortcut row
                    { 0, 1, 2, std::vector<int32_t>{ -1, -1, 0 }, std::wstring(), true, { RemapBufferItem{ Shortcut(), Shortcut() }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 0, 2, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 2, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 2, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_MENU, 0x42 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnWinLError_OnSettingDropDownToWinOrLOnColumnResultingInWinL)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 1, std::vector<int32_t>{ VK_LWIN, 0x4C }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_LWIN }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 2: Validate the element when selecting L (0x4C) on second dropdown of second column of LWin+Empty shortcut
                    { 0, 1, 1, std::vector<int32_t>{ VK_LWIN, 0x4C }, std::wstring(), false, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_LWIN } }, std::wstring(), RemapCondition::Always } },
                    // Case 3: Validate the element when selecting L (0x4C) on second dropdown of second column of hybrid LWin+Empty shortcut
                    { 0, 1, 1, std::vector<int32_t>{ VK_LWIN, 0x4C }, std::wstring(), true, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_LWIN } }, std::wstring(), RemapCondition::Always } },
                    // Case 4: Validate the element when selecting L (0x4C) on second dropdown of first column of Win+Empty shortcut
                    { 0, 0, 1, std::vector<int32_t>{ CommonSharedConstants::VK_WIN_BOTH, 0x4C }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ CommonSharedConstants::VK_WIN_BOTH }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 5: Validate the element when selecting L (0x4C) on second dropdown of second column of Win+Empty shortcut
                    { 0, 1, 1, std::vector<int32_t>{ CommonSharedConstants::VK_WIN_BOTH, 0x4C }, std::wstring(), false, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ CommonSharedConstants::VK_WIN_BOTH } }, std::wstring(), RemapCondition::Always } },
                    // Case 6: Validate the element when selecting L (0x4C) on second dropdown of second column of hybrid Win+Empty shortcut
                    { 0, 1, 1, std::vector<int32_t>{ CommonSharedConstants::VK_WIN_BOTH, 0x4C }, std::wstring(), true, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ CommonSharedConstants::VK_WIN_BOTH } }, std::wstring(), RemapCondition::Always } },
                    // Case 7: Validate the element when selecting LWin (VK_LWIN) on first dropdown of first column of Empty+L shortcut
                    { 0, 0, 0, std::vector<int32_t>{ VK_LWIN, 0x4C }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ 0x4C }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 8: Validate the element when selecting LWin (VK_LWIN) on first dropdown of second column of Empty+L shortcut
                    { 0, 1, 0, std::vector<int32_t>{ VK_LWIN, 0x4C }, std::wstring(), false, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ 0x4C } }, std::wstring(), RemapCondition::Always } },
                    // Case 9: Validate the element when selecting LWin (VK_LWIN) on first dropdown of second column of hybrid Empty+L shortcut
                    { 0, 1, 0, std::vector<int32_t>{ VK_LWIN, 0x4C }, std::wstring(), true, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ 0x4C } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnWinLError_OnSettingDropDownToNullOrNoneOnColumnResultingInWinL)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 2, std::vector<int32_t>{ VK_LWIN, -1, 0x4C }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_LWIN, VK_CONTROL, 0x4C }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 2: Validate the element when selecting Null (-1) on second dropdown of second column of LWin + Ctrl + L shortcut
                    { 0, 1, 2, std::vector<int32_t>{ VK_LWIN, -1, 0x4C }, std::wstring(), false, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_LWIN, VK_CONTROL, 0x4C } }, std::wstring(), RemapCondition::Always } },
                    // Case 3: Validate the element when selecting Null (-1) on second dropdown of second column of hybrid LWin + Ctrl + L shortcut
                    { 0, 1, 2, std::vector<int32_t>{ VK_LWIN, -1, 0x4C }, std::wstring(), true, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_LWIN, VK_CONTROL, 0x4C } }, std::wstring(), RemapCondition::Always } },
                    // Case 4: Validate the element when selecting None (0) on second dropdown of first column of LWin + Ctrl + L shortcut
                    { 0, 0, 2, std::vector<int32_t>{ VK_LWIN, 0, 0x4C }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_LWIN, VK_CONTROL, 0x4C }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 5: Validate the element when selecting None (0) on second dropdown of second column of LWin + Ctrl + L shortcut
                    { 0, 1, 2, std::vector<int32_t>{ VK_LWIN, 0, 0x4C }, std::wstring(), false, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_LWIN, VK_CONTROL, 0x4C } }, std::wstring(), RemapCondition::Always } },
                    // Case 6: Validate the element when selecting None (0) on second dropdown of second column of hybrid LWin + Ctrl + L shortcut
                    { 0, 1, 2, std::vector<int32_t>{ VK_LWIN, 0, 0x4C }, std::wstring(), true, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_LWIN, VK_CONTROL, 0x4C } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnCtrlAltDelError_OnSettingDropDownToCtrlAltOrDelOnColumnResultingInCtrlAltDel)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 2, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_DELETE }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_MENU }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 2: Validate the element when selecting Del (VK_DELETE) on third dropdown of second column of Ctrl+Alt+Empty shortcut
                    { 0, 1, 2, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_DELETE }, std::wstring(), false, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_CONTROL, VK_MENU } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 2, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_DELETE }, std::wstring(), true, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_CONTROL, VK_MENU } }, std::wstring(), RemapCondition::Always } },
                    // Case 4: Validate the element when selecting Alt (VK_MENU) on second dropdown of first column of Ctrl+Empty+Del shortcut
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_DELETE }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_DELETE }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 5: Validate the element when selecting Alt (VK_MENU) on second dropdown of second column of Ctrl+Empty+Del shortcut
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_DELETE }, std::wstring(), false, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_CONTROL, VK_DELETE } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_MENU, VK_DELETE }, std::wstring(), true, { RemapBufferItem{ Shortcut(), std::vector<int32_t>{ VK_CONTROL, VK_DELETE } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnMapToSameKeyError_OnSettingHybridSecondColumnToFirstColumnInKeyTable)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 1, 0, std::vector<int32_t>{ 0x41, -1, -1 }, std::wstring(), true, { RemapBufferItem{ VK_A, VK_NULL }, std::wstring(), RemapCondition::Always } },
                    // Case 2: Validate the element when selecting A (0x41) on second dropdown of empty hybrid second column
                    { 0, 1, 1, std::vector<int32_t>{ -1, 0x41, -1 }, std::wstring(), true, { RemapBufferItem{ VK_A, VK_NULL }, std::wstring(), RemapCondition::Always } },
                    // Case 3: Validate the element when selecting A (0x41) on third dropdown of empty hybrid second column
                    { 0, 1, 2, std::vector<int32_t>{ -1, -1, 0x41 }, std::wstring(), true, { RemapBufferItem{ VK_A, VK_NULL }, std::wstring(), RemapCondition::Always } },
                    // Case 4: Validate the element when selecting A (0x41) on first dropdown of hybrid second column with key
                    { 0, 1, 0, std::vector<int32_t>{ 0x41 }, std::wstring(), true, { RemapBufferItem{ VK_A, VK_C }, std::wstring(), RemapCondition::Always } },
                    // Case 5: Validate the element when selecting Null (-1) on first dropdown of hybrid second column with shortcut
                    { 0, 1, 0, std::vector<int32_t>{ -1, 0x41 }, std::wstring(), true, { RemapBufferItem{ VK_A, std::vector<int32_t>{ VK_CONTROL, 0x41 } }, std::wstring(), RemapCondition::Always } },
                    // Case 6: Validate the element when selecting None (0) on first dropdown of hybrid second column with shortcut
                    { 0, 1, 0, std::vector<int32_t>{ 0, 0x41 }, std::wstring(), true, { RemapBufferItem{ VK_A, std::vector<int32_t>{ VK_CONTROL, 0x41 } }, std::wstring(), RemapCondition::Always } },
                    // Case 7: Validate the element when selecting Null (-1) on second dropdown of hybrid second column with shortcut
                    { 0, 1, 1, std::vector<int32_t>{ -1, VK_CONTROL }, std::wstring(), true, { RemapBufferItem{ VK_CONTROL, std::vector<int32_t>{ VK_CONTROL, 0x41 } }, std::wstring(), RemapCondition::Always } },
                    // Case 8: Validate the element when selecting None (0) on second dropdown of hybrid second column with shortcut
                    { 0, 1, 1, std::vector<int32_t>{ 0, VK_CONTROL }, std::wstring(), true, { RemapBufferItem{ VK_CONTROL, std::vector<int32_t>{ VK_CONTROL, 0x41 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnMapToSameShortcutError_OnSettingOneColumnToTheOtherAndBothAreValid3KeyShortcuts)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 2, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 2 : Validate the element when selecting C (0x43) on third dropdown of second column with Ctrl+Shift+Empty
                    { 0, 1, 2, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT } }, std::wstring(), RemapCondition::Always } },
                    // Case 3 : Validate the element when selecting C (0x43) on third dropdown of second column with hybrid Ctrl+Shift+Empty
                    { 0, 1, 2, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT } }, std::wstring(), RemapCondition::Always } },
                    // Case 4 : Validate the element when selecting Shift (VK_SHIFT) on second dropdown of first column with Ctrl+Empty+C
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 5 : Validate the element when selecting Shift (VK_SHIFT) on second dropdown of second column with Ctrl+Empty+C
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 6 : Validate the element when selecting Shift (VK_SHIFT) on second dropdown of second column with hybrid Ctrl+Empty+C
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 7 : Validate the element when selecting Shift (VK_SHIFT) on first dropdown of first column with Empty+Ctrl+C
                    { 0, 0, 0, std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 8 : Validate the element when selecting Shift (VK_SHIFT) on first dropdown of second column with Empty+Ctrl+C
                    { 0, 1, 0, std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 9 : Validate the element when selecting Shift (VK_SHIFT) on first dropdown of second column with hybrid Empty+Ctrl+C
                    { 0, 1, 0, std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnMapToSameShortcutError_OnSettingOneColumnToTheOtherAndBothAreValid2KeyShortcuts)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 0, 0, 2, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 2 : Validate the element when selecting C (0x43) on third dropdown of second column with Ctrl+Empty+Empty
                    { 0, 1, 2, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL } }, std::wstring(), RemapCondition::Always } },
                    // Case 3 : Validate the element when selecting C (0x43) on third dropdown of second column with hybrid Ctrl+Empty+Empty
                    { 0, 1, 2, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL } }, std::wstring(), RemapCondition::Always } },
                    // Case 4 : Validate the element when selecting C (0x43) on second dropdown of first column with Ctrl+Empty+Empty
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0x43, -1 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 5 : Validate the element when selecting C (0x43) on second dropdown of second column with Ctrl+Empty+Empty
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x43, -1 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL } }, std::wstring(), RemapCondition::Always } },
                    // Case 6 : Validate the element when selecting C (0x43) on second dropdown of second column with hybrid Ctrl+Empty+Empty
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x43, -1 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL } }, std::wstring(), RemapCondition::Always } },
                    // Case 7 : Validate the element when selecting Ctrl (VK_CONTROL) on first dropdown of first column with Empty+Empty+C
                    { 0, 0, 0, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 8 : Validate the element when selecting Ctrl (VK_CONTROL) on first dropdown of second column with Empty+Empty+C
                    { 0, 1, 0, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 9 : Validate the element when selecting Ctrl (VK_CONTROL) on first dropdown of second column with hybrid Empty+Empty+C
                    { 0, 1, 0, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 10 : Validate the element when selecting Ctrl (VK_CONTROL) on second dropdown of first column with Empty+Empty+C
                    { 0, 0, 1, std::vector<int32_t>{ -1, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 11 : Validate the element when selecting Ctrl (VK_CONTROL) on second dropdown of second column with Empty+Empty+C
                    { 0, 1, 1, std::vector<int32_t>{ -1, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ 0x43 } }, std::wstring(), RemapCondition::Always } },
                    ...
                    { 0, 1, 1, std::vector<int32_t>{ -1, VK_CONTROL, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 13 : Validate the element when selecting C (0x43) on second dropdown of first column with Ctrl+A
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x41 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 14 : Validate the element when selecting C (0x43) on second dropdown of second column with Ctrl+A
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x41 } }, std::wstring(), RemapCondition::Always } },
                    // Case 15 : Validate the element when selecting C (0x43) on second dropdown of second column with hybrid Ctrl+A
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x41 } }, std::wstring(), RemapCondition::Always } },
                    // Case 16 : Validate the element when selecting Ctrl (VK_CONTROL) on first dropdown of first column with Alt+C
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_MENU, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 17 : Validate the element when selecting Ctrl (VK_CONTROL) on first dropdown of second column with Alt+C
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_MENU, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 18 : Validate the element when selecting Ctrl (VK_CONTROL) on first dropdown of second column with hybrid Alt+C
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_MENU, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 19 : Validate the element when selecting Null (-1)  on second dropdown of first column with Ctrl+Shift+C
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 20 : Validate the element when selecting Null (-1)  on second dropdown of second column with Ctrl+Shift+C
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 21 : Validate the element when selecting Null (-1)  on second dropdown of second column with hybrid Ctrl+Shift+C
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 22 : Validate the element when selecting None (0)  on second dropdown of first column with Ctrl+Shift+C
                    { 0, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 23 : Validate the element when selecting None (0)  on second dropdown of second column with Ctrl+Shift+C
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 24 : Validate the element when selecting None (0)  on second dropdown of second column with hybrid Ctrl+Shift+C
                    { 0, 1, 1, std::vector<int32_t>{ VK_CONTROL, 0, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 25 : Validate the element when selecting Null (-1)  on first dropdown of first column with Shift+Ctrl+C
                    { 0, 0, 0, std::vector<int32_t>{ -1, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 26 : Validate the element when selecting Null (-1)  on first dropdown of second column with Shift+Ctrl+C
                    { 0, 1, 0, std::vector<int32_t>{ -1, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 27 : Validate the element when selecting Null (-1)  on first dropdown of second column with hybrid Shift+Ctrl+C
                    { 0, 1, 0, std::vector<int32_t>{ -1, VK_CONTROL, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 28 : Validate the element when selecting None (0)  on first dropdown of first column with Shift+Ctrl+C
                    { 0, 0, 0, std::vector<int32_t>{ 0, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 29 : Validate the element when selecting None (0)  on first dropdown of second column with Shift+Ctrl+C
                    { 0, 1, 0, std::vector<int32_t>{ 0, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                    // Case 30 : Validate the element when selecting None (0)  on first dropdown of second column with hybrid Shift+Ctrl+C
                    { 0, 1, 0, std::vector<int32_t>{ 0, VK_CONTROL, 0x43 }, std::wstring(), true, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 } }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnSameShortcutPreviouslyMappedError_OnSettingFirstColumnToFirstColumnInAnotherRowWithSameTargetAppAndBothAreValid3KeyShortcuts)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    // Case 1 : Validate the element when selecting C (0x43) on third dropdown of first column with Ctrl+Shift+Empty
                    { 1, 0, 2, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 2 : Validate the element when selecting Shift (VK_SHIFT) on second dropdown of first column with Ctrl+Empty+C
                    { 1, 0, 1, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 3 : Validate the element when selecting Shift (VK_SHIFT) on first dropdown of first column with Empty+Ctrl+C
                    { 1, 0, 0, std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                };
                ...
                RunTestCases(testCases, [this](const ValidateShortcutBufferElementArgs& testCase) {
                    ...
                    RemapBuffer remapBuffer{
                        ...
                        { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always },
                        testCase.bufferRow,
                    };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoError_OnSettingFirstColumnToFirstColumnInAnotherRowWithDifferentTargetAppAndBothAreValid3KeyShortcuts)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 1, 0, 2, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT }, Shortcut() }, testApp2, RemapCondition::Always } },
                    ...
                    { 1, 0, 1, std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    ...
                    { 1, 0, 0, std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                };
                ...
                RunTestCases(testCases, [this](const ValidateShortcutBufferElementArgs& testCase) {
                    ...
                    RemapBuffer remapBuffer{
                        ...
                        { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, Shortcut() }, testApp1, RemapCondition::Always },
                        testCase.bufferRow,
                    };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnConflictingModifierShortcutError_OnSettingFirstColumnToConflictWithFirstColumnInAnotherRowWithSameTargetAppAndBothAreValid3KeyShortcuts)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 1, 0, 2, std::vector<int32_t>{ VK_LCONTROL, VK_SHIFT, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL, VK_SHIFT }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 2 : Validate the element when selecting Shift (VK_SHIFT) on second dropdown of first column with LCtrl+Empty+C
                    { 1, 0, 1, std::vector<int32_t>{ VK_LCONTROL, VK_SHIFT, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 3 : Validate the element when selecting LShift (VK_LSHIFT) on first dropdown of first column with Empty+Ctrl+C
                    { 1, 0, 0, std::vector<int32_t>{ VK_LSHIFT, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoError_OnSettingFirstColumnToConflictWithFirstColumnInAnotherRowWithDifferentTargetAppAndBothAreValid3KeyShortcuts)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 1, 0, 2, std::vector<int32_t>{ VK_LCONTROL, VK_SHIFT, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL, VK_SHIFT }, Shortcut() }, testApp2, RemapCondition::Always } },
                    ...
                    { 1, 0, 1, std::vector<int32_t>{ VK_LCONTROL, VK_SHIFT, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    ...
                    { 1, 0, 0, std::vector<int32_t>{ VK_LSHIFT, VK_CONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnSameShortcutPreviouslyMappedError_OnSettingFirstColumnToFirstColumnInAnotherRowWithSameTargetAppAndBothAreValid2KeyShortcuts)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 1, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 2 : Validate the element when selecting C (0x43) on third dropdown of first column with Ctrl+Empty+Empty
                    { 1, 0, 2, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 3 : Validate the element when selecting C (0x43) on second dropdown of first column with Ctrl+Empty+Empty
                    { 1, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0x43, -1 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 4 : Validate the element when selecting Ctrl (VK_CONTROL) on first dropdown of first column with Empty+C
                    { 1, 0, 0, std::vector<int32_t>{ VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 5 : Validate the element when selecting Ctrl (VK_CONTROL) on first dropdown of first column with Empty+Empty+C
                    { 1, 0, 0, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 6 : Validate the element when selecting Ctrl (VK_CONTROL) on second dropdown of first column with Empty+Empty+C
                    { 1, 0, 1, std::vector<int32_t>{ -1, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 7 : Validate the element when selecting Null (-1) on second dropdown of first column with Ctrl+Shift+C
                    { 1, 0, 1, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 8 : Validate the element when selecting Null (-1) on first dropdown of first column with Shift+Ctrl+C
                    { 1, 0, 0, std::vector<int32_t>{ -1, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 9 : Validate the element when selecting None (0) on second dropdown of first column with Ctrl+Shift+C
                    { 1, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 10 : Validate the element when selecting None (0) on first dropdown of first column with Shift+Ctrl+C
                    { 1, 0, 0, std::vector<int32_t>{ 0, VK_CONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                };
                ...
                RunTestCases(testCases, [this](const ValidateShortcutBufferElementArgs& testCase) {
                    ...
                    RemapBuffer remapBuffer{
                        // Ctrl+C remapped
                        { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always },
                        testCase.bufferRow,
                    };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoError_OnSettingFirstColumnToFirstColumnInAnotherRowWithDifferentTargetAppAndBothAreValid2KeyShortcuts)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 1, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 2 : Validate the element when selecting C (0x43) on third dropdown of first column with Ctrl+Empty+Empty for testApp2
                    { 1, 0, 2, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 3 : Validate the element when selecting C (0x43) on second dropdown of first column with Ctrl+Empty+Empty for testApp2
                    { 1, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0x43, -1 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 4 : Validate the element when selecting Ctrl (VK_CONTROL) on first dropdown of first column with Empty+C for testApp2
                    { 1, 0, 0, std::vector<int32_t>{ VK_CONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    ...
                    { 1, 0, 0, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    ...
                    { 1, 0, 1, std::vector<int32_t>{ -1, VK_CONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 7 : Validate the element when selecting Null (-1) on second dropdown of first column with Ctrl+Shift+C for testApp2
                    { 1, 0, 1, std::vector<int32_t>{ VK_CONTROL, -1, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 8 : Validate the element when selecting Null (-1) on first dropdown of first column with Shift+Ctrl+C for testApp2
                    { 1, 0, 0, std::vector<int32_t>{ -1, VK_CONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 9 : Validate the element when selecting None (0) on second dropdown of first column with Ctrl+Shift+C for testApp2
                    { 1, 0, 1, std::vector<int32_t>{ VK_CONTROL, 0, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, VK_SHIFT, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 10 : Validate the element when selecting None (0) on first dropdown of first column with Shift+Ctrl+C for testApp2
                    { 1, 0, 0, std::vector<int32_t>{ 0, VK_CONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_SHIFT, VK_CONTROL, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                };
                ...
                RunTestCases(testCases, [this](const ValidateShortcutBufferElementArgs& testCase) {
                    ...
                    RemapBuffer remapBuffer{
                        ...
                        { RemapBufferItem{ std::vector<int32_t>{ VK_CONTROL, 0x43 }, Shortcut() }, testApp1, RemapCondition::Always },
                        testCase.bufferRow,
                    };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnConflictingModifierShortcutError_OnSettingFirstColumnToConflictWithFirstColumnInAnotherRowWithSameTargetAppAndBothAreValid2KeyShortcuts)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 1, 0, 1, std::vector<int32_t>{ VK_LCONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 2 : Validate the element when selecting C (0x43) on third dropdown of first column with LCtrl+Empty+Empty
                    { 1, 0, 2, std::vector<int32_t>{ VK_LCONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 3 : Validate the element when selecting C (0x43) on second dropdown of first column with LCtrl+Empty+Empty
                    { 1, 0, 1, std::vector<int32_t>{ VK_LCONTROL, 0x43, -1 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 4 : Validate the element when selecting LCtrl (VK_LCONTROL) on first dropdown of first column with Empty+C
                    { 1, 0, 0, std::vector<int32_t>{ VK_LCONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 5 : Validate the element when selecting LCtrl (VK_LCONTROL) on first dropdown of first column with Empty+Empty+C
                    { 1, 0, 0, std::vector<int32_t>{ VK_LCONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 6 : Validate the element when selecting LCtrl (VK_LCONTROL) on second dropdown of first column with Empty+Empty+C
                    { 1, 0, 1, std::vector<int32_t>{ -1, VK_LCONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 7 : Validate the element when selecting Null (-1) on second dropdown of first column with LCtrl+Shift+C
                    { 1, 0, 1, std::vector<int32_t>{ VK_LCONTROL, -1, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL, VK_SHIFT, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 8 : Validate the element when selecting Null (-1) on first dropdown of first column with Shift+LCtrl+C
                    { 1, 0, 0, std::vector<int32_t>{ -1, VK_LCONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_SHIFT, VK_LCONTROL, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 9 : Validate the element when selecting None (0) on second dropdown of first column with LCtrl+Shift+C
                    { 1, 0, 1, std::vector<int32_t>{ VK_LCONTROL, 0, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL, VK_SHIFT, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                    // Case 10 : Validate the element when selecting None (0) on first dropdown of first column with Shift+LCtrl+C
                    { 1, 0, 0, std::vector<int32_t>{ 0, VK_LCONTROL, 0x43 }, std::wstring(), false, { RemapBufferItem{ std::vector<int32_t>{ VK_SHIFT, VK_LCONTROL, 0x43 }, Shortcut() }, std::wstring(), RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnNoError_OnSettingFirstColumnToConflictWithFirstColumnInAnotherRowWithDifferentTargetAppAndBothAreValid2KeyShortcuts)
            {
                const std::vector<ValidateShortcutBufferElementArgs> testCases{
                    ...
                    { 1, 0, 1, std::vector<int32_t>{ VK_LCONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 2 : Validate the element when selecting C (0x43) on third dropdown of first column with LCtrl+Empty+Empty for testApp2
                    { 1, 0, 2, std::vector<int32_t>{ VK_LCONTROL, -1, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 3 : Validate the element when selecting C (0x43) on second dropdown of first column with LCtrl+Empty+Empty for testApp2
                    { 1, 0, 1, std::vector<int32_t>{ VK_LCONTROL, 0x43, -1 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 4 : Validate the element when selecting LCtrl (VK_LCONTROL) on first dropdown of first column with Empty+C for testApp2
                    { 1, 0, 0, std::vector<int32_t>{ VK_LCONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    ...
                    { 1, 0, 0, std::vector<int32_t>{ VK_LCONTROL, -1, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    ...
                    { 1, 0, 1, std::vector<int32_t>{ -1, VK_LCONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 7 : Validate the element when selecting Null (-1) on second dropdown of first column with LCtrl+Shift+C for testApp2
                    { 1, 0, 1, std::vector<int32_t>{ VK_LCONTROL, -1, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL, VK_SHIFT, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 8 : Validate the element when selecting Null (-1) on first dropdown of first column with Shift+LCtrl+C for testApp2
                    { 1, 0, 0, std::vector<int32_t>{ -1, VK_LCONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_SHIFT, VK_LCONTROL, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 9 : Validate the element when selecting None (0) on second dropdown of first column with LCtrl+Shift+C for testApp2
                    { 1, 0, 1, std::vector<int32_t>{ VK_LCONTROL, 0, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_LCONTROL, VK_SHIFT, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                    // Case 10 : Validate the element when selecting None (0) on first dropdown of first column with Shift+LCtrl+C for testApp2
                    { 1, 0, 0, std::vector<int32_t>{ 0, VK_LCONTROL, 0x43 }, testApp2, false, { RemapBufferItem{ std::vector<int32_t>{ VK_SHIFT, VK_LCONTROL, 0x43 }, Shortcut() }, testApp2, RemapCondition::Always } },
                };
            ...
            TEST_METHOD (ValidateShortcutBufferElement_ShouldReturnDisableAsActionKeyError_OnSettingSecondDropdownAsDisable)
            {
                // Arrange
                RemapBuffer remapBuffer{
                    { RemapBufferItem{ std::vector<int32_t>{ VK_SHIFT, CommonSharedConstants::VK_DISABLED }, Shortcut() }, testApp1, RemapCondition::Always },
                };
