...
namespace KeyboardEventHandlers
{
    ...
    */
    ...
    __declspec(dllexport) intptr_t HandleShortcutRemapEvent(KeyboardManagerInput::InputInterface& ii, LowlevelKeyboardEvent* data, KeyboardManagerState& keyboardManagerState, const std::optional<std::wstring>& activatedApp) noexcept
    {
