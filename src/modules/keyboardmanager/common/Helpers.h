...
namespace Helpers
{
    ...
    void SetModifierKeyEvents(const Shortcut& shortcutToBeSent, const Modifiers& winKeyInvoked, std::vector<INPUT>& keyEventArray, bool isKeyDown, ULONG_PTR extraInfoFlag, const Shortcut& shortcutToCompare = Shortcut(), const DWORD& keyToBeReleased = NULL);
