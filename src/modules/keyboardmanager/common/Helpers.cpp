...
namespace Helpers
{
    ...
    void SetKeyEvent(std::vector<INPUT>& keyEventArray, DWORD inputType, DWORD keyCode, DWORD flags, ULONG_PTR extraInfo)
    {
        auto keyEvent = INPUT{};
        keyEvent.type = inputType;
        keyEvent.ki.wVk = static_cast<WORD>(keyCode);
    ...
    void SetModifierKeyEvents(const Shortcut& shortcutToBeSent, const ModifierKey& winKeyInvoked, std::vector<INPUT>& keyEventArray, bool isKeyDown, ULONG_PTR extraInfoFlag, const Shortcut& shortcutToCompare, const DWORD& keyToBeReleased)
    {
        ...
        if (isKeyDown)
        {
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, shortcutToBeSent.GetWinKey(winKeyInvoked), 0, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, shortcutToBeSent.GetCtrlKey(), 0, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, shortcutToBeSent.GetAltKey(), 0, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, shortcutToBeSent.GetShiftKey(), 0, extraInfoFlag);
            }
        }
        ...
        else
        {
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, static_cast<DWORD>(shortcutToBeSent.GetShiftKey()), KEYEVENTF_KEYUP, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, static_cast<DWORD>(shortcutToBeSent.GetAltKey()), KEYEVENTF_KEYUP, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, static_cast<DWORD>(shortcutToBeSent.GetCtrlKey()), KEYEVENTF_KEYUP, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, static_cast<DWORD>(shortcutToBeSent.GetWinKey(winKeyInvoked)), KEYEVENTF_KEYUP, extraInfoFlag);
            }
        }
    }
