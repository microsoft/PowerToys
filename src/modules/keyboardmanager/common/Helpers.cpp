...
namespace Helpers
{
    ...
    void SetKeyEvent(std::vector<INPUT>& keyEventArray, DWORD inputType, WORD keyCode, DWORD flags, ULONG_PTR extraInfo)
    {
        ...
        keyEvent.ki.wScan = (WORD)MapVirtualKey(keyCode, MAPVK_VK_TO_VSC);
    ...
    {
        SetKeyEvent(keyEventArray, INPUT_KEYBOARD, (WORD)KeyboardManagerConstants::DUMMY_KEY, 0, extraInfo);
        SetKeyEvent(keyEventArray, INPUT_KEYBOARD, (WORD)KeyboardManagerConstants::DUMMY_KEY, KEYEVENTF_KEYUP, extraInfo);
    }
    ...
    void SetModifierKeyEvents(const Shortcut& shortcutToBeSent, const ModifierKey& winKeyInvoked, std::vector<INPUT>& keyEventArray, bool isKeyDown, ULONG_PTR extraInfoFlag, const Shortcut& shortcutToCompare, const DWORD& keyToBeReleased)
    {
        ...
        if (isKeyDown)
        {
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, (WORD)shortcutToBeSent.GetWinKey(winKeyInvoked), 0, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, (WORD)shortcutToBeSent.GetCtrlKey(), 0, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, (WORD)shortcutToBeSent.GetAltKey(), 0, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, (WORD)shortcutToBeSent.GetShiftKey(), 0, extraInfoFlag);
            }
        }
        ...
        else
        {
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, (WORD)shortcutToBeSent.GetShiftKey(), KEYEVENTF_KEYUP, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, (WORD)shortcutToBeSent.GetAltKey(), KEYEVENTF_KEYUP, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, (WORD)shortcutToBeSent.GetCtrlKey(), KEYEVENTF_KEYUP, extraInfoFlag);
            }
            ...
            {
                Helpers::SetKeyEvent(keyEventArray, INPUT_KEYBOARD, (WORD)shortcutToBeSent.GetWinKey(winKeyInvoked), KEYEVENTF_KEYUP, extraInfoFlag);
            }
        }
    }
