...
public:
    ...
    static void AddNewShortcutControlRow(StackPanel& parent, const std::vector<DWORD>& originalKeys = std::vector<DWORD>(), const std::vector<DWORD>& newKeys = std::vector<DWORD>());
