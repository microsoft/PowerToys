...
void createEditKeyboardWindow(HINSTANCE hInst, KeyboardManagerState& keyboardManagerState)
{
    ...
    keyRemapInfoExample.Margin({ 10, 0, 0, 10 });
    keyRemapInfoExample.FontStyle(Text::FontStyle::Italic);

    TextBlock keyRemapPressPlus;
    keyRemapPressPlus.Text(L"Press the + button to get started");
    keyRemapPressPlus.Margin({ 10, 10, 0, 10 });
    ...
    mappingsPanel.Children().Append(keyRemapPressPlus);
