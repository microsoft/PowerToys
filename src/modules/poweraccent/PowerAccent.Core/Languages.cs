    ...
    internal sealed class Languages
    {
        public static string[] GetDefaultLetterKey(LetterKey letter, Language lang)
        {
            return lang switch
            {
                ...
                Language.MATH => GetDefaultLetterKeyMATH(letter), // Math
        ...
        private static string[] GetDefaultLetterKeyMATH(LetterKey letter)
        {
            return letter switch
            {
                ...
                LetterKey.VK_C => new[] { "ℂ", "χ" },
                LetterKey.VK_D => new[] { "δ" },
                LetterKey.VK_E => new[] { "ε", "∃", "∄" },
                LetterKey.VK_F => new[] { "ƒ" },
                LetterKey.VK_G => new[] { "γ" },
                LetterKey.VK_L => new[] { "λ" },
                LetterKey.VK_M => new[] { "μ" },
                LetterKey.VK_N => new[] { "ⁿ", "ℕ", "ν" },
                LetterKey.VK_O => new[] { "ø", "ω" },
                LetterKey.VK_Q => new[] { "ℚ" },
                LetterKey.VK_P => new[] { "π", "φ", "ψ", "⊥" },
                LetterKey.VK_R => new[] { "ℝ", "ρ" },
                LetterKey.VK_S => new[] { "σ", "ß", "∫" },
                LetterKey.VK_T => new[] { "θ", "τ", "þ" },
                LetterKey.VK_U => new[] { "υ" },
                LetterKey.VK_X => new[] { "ξ", "⊕" },
                LetterKey.VK_Z => new[] { "ℤ", "ζ" },
                LetterKey.VK_BACKSLASH => new[] { "⋃", "⋁" },
                LetterKey.VK_EQUALS => new[] { "≠", "≈", "⇔", "≡", "≙", "±", "₊", "⁺" },
                LetterKey.VK_COMMA => new[] { "≤", "⇐", "⊆", "⊂", "⊄", "∌", "∋", "≪" },
