    ...
    internal sealed class Languages
    {
        ...
        private static string[] GetDefaultLetterKeySPECIAL(LetterKey letter)
        {
            return letter switch
            {
                ...
                LetterKey.VK_8 => new[] { "₈", "⁸", "∞" },
                LetterKey.VK_9 => new[] { "₉", "⁹", "₍", "⁽" },
                LetterKey.VK_A => new[] { "ȧ", "ǽ", "∀", "ᵃ", "ₐ", "α", "Α" },
                LetterKey.VK_B => new[] { "ḃ", "ᵇ", "β", "Β" },
                LetterKey.VK_C => new[] { "ċ", "°C", "©", "ℂ", "∁", "ᶜ", "χ", "Χ" },
                LetterKey.VK_D => new[] { "ḍ", "ḋ", "∂", "ᵈ", "δ", "Δ" },
                LetterKey.VK_E => new[] { "∈", "∃", "∄", "∉", "ĕ", "ᵉ", "ₑ", "ε", "Ε", "η", "Η" },
                LetterKey.VK_F => new[] { "ḟ", "°F", "ᶠ", "φ", "Φ" },
                LetterKey.VK_G => new[] { "ģ", "ǧ", "ġ", "ĝ", "ǥ", "ᵍ", "γ", "Γ" },
                LetterKey.VK_H => new[] { "ḣ", "ĥ", "ħ", "ʰ", "ₕ" },
                LetterKey.VK_I => new[] { "ⁱ", "ᵢ", "ι", "Ι" },
                LetterKey.VK_J => new[] { "ĵ", "ʲ", "ⱼ" },
                LetterKey.VK_K => new[] { "ķ", "ǩ", "ᵏ", "ₖ", "κ", "Κ" },
                LetterKey.VK_L => new[] { "ļ", "₺", "ˡ", "ₗ", "λ", "Λ" }, // ₺ is in VK_T for other languages, but not VK_L, so we add it here.
                LetterKey.VK_M => new[] { "ṁ", "ᵐ", "ₘ", "μ", "Μ" },
                LetterKey.VK_N => new[] { "ņ", "ṅ", "ⁿ", "ℕ", "№", "ₙ", "ν", "Ν" },
                LetterKey.VK_O => new[] { "ȯ", "∅", "⌀", "ᵒ", "ₒ", "ο", "Ο", "ω", "Ω" },
                LetterKey.VK_P => new[] { "ṗ", "℗", "∏", "¶", "ᵖ", "ₚ", "π", "Π", "ψ", "Ψ" },
                LetterKey.VK_Q => new[] { "ℚ", "𐞥", "θ", "Θ" },
                LetterKey.VK_R => new[] { "ṙ", "®", "ℝ", "ʳ", "ᵣ", "ρ", "Ρ" },
                LetterKey.VK_S => new[] { "ṡ", "§", "∑", "∫", "ˢ", "ₛ", "σ", "Σ" },
                LetterKey.VK_T => new[] { "ţ", "ṫ", "ŧ", "™", "ᵗ", "ₜ", "τ", "Τ" },
                LetterKey.VK_U => new[] { "ŭ", "ᵘ", "ᵤ", "υ", "Υ" },
                LetterKey.VK_V => new[] { "V̇", "ᵛ", "ᵥ" },
                LetterKey.VK_W => new[] { "ẇ", "ʷ" },
                LetterKey.VK_X => new[] { "ẋ", "×", "ˣ", "ₓ", "ξ", "Ξ" },
                LetterKey.VK_Y => new[] { "ẏ", "ꝡ", "ʸ" },
                LetterKey.VK_Z => new[] { "ʒ", "ǯ", "ℤ", "ᶻ", "ζ", "Ζ" },
