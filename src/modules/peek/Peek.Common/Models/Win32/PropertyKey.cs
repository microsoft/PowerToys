...
namespace Peek.Common.Models
{
    ...
    public struct PropertyKey
    {
        ...
        // Link (shortcut) properties: https://learn.microsoft.com/en-us/windows/win32/properties/props-system-link-targetparsingpath
        public static readonly PropertyKey LinkTargetParsingPath = new PropertyKey(new Guid(0xB9B4B3FC, 0x2B51, 0x4A42, 0xB5, 0xD8, 0x32, 0x41, 0x46, 0xAF, 0xCF, 0x25), 2);
    }
}
