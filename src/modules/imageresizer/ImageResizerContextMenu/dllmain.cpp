...
private:
    ...
    HRESULT ResizePictures(IShellItemArray* psiItemArray)
    {
        ...
        else if (UuidToString(&temp_uuid, static_cast<RPC_WSTR*>(static_cast<void*>( & uuid_chars))) != RPC_S_OK)
        {
            auto val = get_last_error_message(GetLastError());
        ...
        if (uuid_chars != nullptr)
        {
            ...
            RpcStringFree(static_cast<RPC_WSTR*>(static_cast<void*>(&uuid_chars)));
            uuid_chars = nullptr;
        }
