...
internal class WindowsRecycleBinService : IRecycleBinService
{
    ...
    public RecycleBinInfo QueryRecycleBin(string path = null)
    {
        ...
        if (result != S_OK)
        {
            // SHQueryRecycleBinW returns an HRESULT; use Marshal.ThrowExceptionForHR
            // rather than Win32Exception, which expects a Win32 error code.
            Marshal.ThrowExceptionForHR(result);
        }

        return new RecycleBinInfo(info.i64NumItems, info.i64Size);
    }
