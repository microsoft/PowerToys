...
{
    private static readonly string AccessibleTypeError = ResourceLoaderInstance.GetString("Results_ErrorItemType_AccessibilityText");
    private static readonly string AccessibleTypeWarning = ResourceLoaderInstance.GetString("Results_WarningItemType_AccessibilityText");
