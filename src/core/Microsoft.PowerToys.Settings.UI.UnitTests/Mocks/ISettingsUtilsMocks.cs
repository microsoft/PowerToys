...
namespace Microsoft.PowerToys.Settings.UI.UnitTests.Mocks
{
    internal static class ISettingsUtilsMocks
    {
        ...
        internal static Mock<ISettingsUtils> GetStubSettingsUtils()
        {
            ...
            settingsUtils.Setup(x => x.GetSettings<ColorPickerSettings>(It.IsAny<string>(), It.IsAny<string>())).Returns(new ColorPickerSettings());
            ...
            settingsUtils.Setup(x => x.GetSettings<PowerLauncherSettings>(It.IsAny<string>(), It.IsAny<string>())).Returns(new PowerLauncherSettings());
