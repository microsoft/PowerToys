...
#define ExitFunction() \
    ...
    bool AutoStart::CreateAutoStartTaskForThisUser(bool runElevated)
    {
        HRESULT hr = S_OK;
    ...
    bool AutoStart::DeleteAutoStartTaskForThisUser()
    {
        HRESULT hr = S_OK;
    ...
    bool AutoStart::IsAutoStartTaskActiveForThisUser()
    {
        HRESULT hr = S_OK;
