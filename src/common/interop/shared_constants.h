...
namespace CommonSharedConstants
{
    ...
    // Path to the events used by Robocopy UI
    const wchar_t ROBOCOPY_UI_LAUNCH_EVENT[] = L"Local\\PowerToysRobocopyUI-LaunchEvent-55ecb679-2b9a-4518-a6ae-d845d34b0b68";
