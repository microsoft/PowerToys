...
namespace CommonSharedConstants
{
    ...
    // Path to the event used by MediaPreviewHandler
    const wchar_t MEDIA_PREVIEW_RESIZE_EVENT[] = L"Local\\PowerToysMediaPreviewResizeEvent-8f7a2b1c-3d4e-5f6a-7b8c-9d0e1f2a3b4c";
