...
namespace Microsoft.PowerToys.Settings.UI.Library
{
    public class CursorWrapProperties
    {
        ...
        [JsonPropertyName("suppress_top_edge_wrap_in_remote_session")]
        public BoolProperty SuppressTopEdgeWrapInRemoteSession { get; set; }
        ...
        public CursorWrapProperties()
        {
            ...
            SuppressTopEdgeWrapInRemoteSession = new BoolProperty(false);
        }
    }
}
