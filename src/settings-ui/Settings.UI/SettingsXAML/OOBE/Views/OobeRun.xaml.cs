...
namespace Microsoft.PowerToys.Settings.UI.OOBE.Views
{
    ...
    public sealed partial class OobeRun : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            HotkeyControl.Keys = SettingsRepository<PowerLauncherSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.OpenPowerLauncher.GetKeysList();
        }
