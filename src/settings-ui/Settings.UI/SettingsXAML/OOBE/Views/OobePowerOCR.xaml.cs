...
namespace Microsoft.PowerToys.Settings.UI.OOBE.Views
{
    public sealed partial class OobePowerOCR : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            HotkeyControl.Keys = SettingsRepository<PowerOcrSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.ActivationShortcut.GetKeysList();
        }
