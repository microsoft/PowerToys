...
namespace Microsoft.PowerToys.Settings.UI.OOBE.Views
{
    ...
    public sealed partial class OobeWorkspaces : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            HotkeyControl.Keys = SettingsRepository<WorkspacesSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.Hotkey.Value.GetKeysList();
        }
