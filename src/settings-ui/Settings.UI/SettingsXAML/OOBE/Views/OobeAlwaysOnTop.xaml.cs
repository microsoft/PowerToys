...
namespace Microsoft.PowerToys.Settings.UI.OOBE.Views
{
    public sealed partial class OobeAlwaysOnTop : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            HotkeyControl.Keys = SettingsRepository<AlwaysOnTopSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.Hotkey.Value.GetKeysList();
        }
