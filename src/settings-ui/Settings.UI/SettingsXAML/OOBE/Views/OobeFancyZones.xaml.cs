...
namespace Microsoft.PowerToys.Settings.UI.OOBE.Views
{
    public sealed partial class OobeFancyZones : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            HotkeyControl.Keys = SettingsRepository<FancyZonesSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.FancyzonesEditorHotkey.Value.GetKeysList();
        }
