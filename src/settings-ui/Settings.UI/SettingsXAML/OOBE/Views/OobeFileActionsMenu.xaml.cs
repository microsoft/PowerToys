...
namespace Microsoft.PowerToys.Settings.UI.OOBE.Views
{
    ...
    public sealed partial class OobeFileActionsMenu : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            HotkeyControl.Keys = SettingsRepository<FileActionsMenuSettings>.GetInstance(new SettingsUtils()).SettingsConfig.Properties.FileActionsMenuShortcut.GetKeysList();
        }
