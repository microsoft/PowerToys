...
namespace Microsoft.PowerToys.Settings.UI.OOBE.Views
{
    ...
    public sealed partial class OobePeek : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            HotkeyControl.Keys = SettingsRepository<PeekSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.ActivationShortcut.GetKeysList();
        }
