...
namespace Microsoft.PowerToys.Settings.UI.OOBE.Views
{
    ...
    public sealed partial class OobeMeasureTool : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            HotkeyActivation.Keys = SettingsRepository<MeasureToolSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.ActivationShortcut.GetKeysList();
        }
