...
namespace Microsoft.PowerToys.Settings.UI
{
    ...
    public partial class App : Application
    {
        ...
        private void OnLaunchedToSetSetting(string[] cmdArgs)
        {
            ...
            try
            {
                SetSettingCommandLineCommand.Execute(settingName, settingValue, SettingsUtils.GlobalDefaultInstance);
            }
            catch (Exception ex)
            {
        ...
        private void OnLaunchedToSetAdditionalSetting(string[] cmdArgs)
        {
            ...
            try
            {
                ...
                {
                    SetAdditionalSettingsCommandLineCommand.Execute(moduleName, settings, SettingsUtils.GlobalDefaultInstance);
                }
            }
            catch (Exception ex)
            {
        ...
        private static ISettingsUtils settingsUtils = SettingsUtils.GlobalDefaultInstance;
