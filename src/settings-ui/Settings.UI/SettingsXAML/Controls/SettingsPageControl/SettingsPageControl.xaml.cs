...
namespace Microsoft.PowerToys.Settings.UI.Controls
{
    public sealed partial class SettingsPageControl : UserControl
    {
        ...
        public ImageSource ModuleImageSource
        {
            get => (ImageSource)GetValue(ModuleImageSourceProperty);
        ...
        public static readonly DependencyProperty ModuleImageSourceProperty = DependencyProperty.Register(nameof(ModuleImageSource), typeof(ImageSource), typeof(SettingsPageControl), new PropertyMetadata(null));
