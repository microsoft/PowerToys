        ...
        private void ModuleButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch ((ModuleType)selectedModuleBtn.Tag)
            {
                ...
                case ModuleType.EnvironmentVariables: // Launch Environment Variables
                    {
                        bool launchAdmin = SettingsRepository<EnvironmentVariablesSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.LaunchAdministrator;
                ...
                case ModuleType.Hosts: // Launch Hosts
                    {
                        bool launchAdmin = SettingsRepository<HostsSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.LaunchAdministrator;
                        string eventName = !App.IsElevated && launchAdmin
