...
namespace Microsoft.PowerToys.Settings.UI.ViewModels
{
    public partial class LauncherViewModel : Observable
    {
        ...
        private string GetModuleToolTip(ModuleType moduleType)
        {
            ...
            {
                ModuleType.ColorPicker => SettingsRepository<ColorPickerSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.ActivationShortcut.ToString(),
                ModuleType.FancyZones => SettingsRepository<FancyZonesSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.FancyzonesEditorHotkey.Value.ToString(),
                ModuleType.PowerLauncher => SettingsRepository<PowerLauncherSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.OpenPowerLauncher.ToString(),
                ModuleType.PowerOCR => SettingsRepository<PowerOcrSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.ActivationShortcut.ToString(),
                ModuleType.Workspaces => SettingsRepository<WorkspacesSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.Hotkey.Value.ToString(),
                ModuleType.MeasureTool => SettingsRepository<MeasureToolSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig.Properties.ActivationShortcut.ToString(),
        ...
        {
            var shortcutGuideSettings = SettingsRepository<ShortcutGuideSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance).SettingsConfig;
