...
namespace Microsoft.PowerToys.Settings.UI.ViewModels
{
    public partial class DashboardViewModel : PageViewModelBase
    {
        ...
        {
            ISettingsRepository<AlwaysOnTopSettings> moduleSettingsRepository = SettingsRepository<AlwaysOnTopSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
        ...
        {
            ISettingsRepository<ColorPickerSettings> moduleSettingsRepository = SettingsRepository<ColorPickerSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
        ...
        {
            ISettingsRepository<LightSwitchSettings> moduleSettingsRepository = SettingsRepository<LightSwitchSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var settings = moduleSettingsRepository.SettingsConfig;
            var list = new List<DashboardModuleItem>
            {
        ...
        {
            ISettingsRepository<CropAndLockSettings> moduleSettingsRepository = SettingsRepository<CropAndLockSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var settings = moduleSettingsRepository.SettingsConfig;
            var list = new List<DashboardModuleItem>
            {
        ...
        {
            ISettingsRepository<FancyZonesSettings> moduleSettingsRepository = SettingsRepository<FancyZonesSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var settings = moduleSettingsRepository.SettingsConfig;
        ...
        {
            ISettingsRepository<FindMyMouseSettings> moduleSettingsRepository = SettingsRepository<FindMyMouseSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
        ...
        {
            ISettingsRepository<MouseHighlighterSettings> moduleSettingsRepository = SettingsRepository<MouseHighlighterSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var list = new List<DashboardModuleItem>
            {
        ...
        {
            ISettingsRepository<MouseJumpSettings> moduleSettingsRepository = SettingsRepository<MouseJumpSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var list = new List<DashboardModuleItem>
            {
        ...
        {
            ISettingsRepository<MousePointerCrosshairsSettings> moduleSettingsRepository = SettingsRepository<MousePointerCrosshairsSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var list = new List<DashboardModuleItem>
            {
        ...
        {
            ISettingsRepository<AdvancedPasteSettings> moduleSettingsRepository = SettingsRepository<AdvancedPasteSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var list = new List<DashboardModuleItem>
            {
        ...
        {
            ISettingsRepository<PeekSettings> moduleSettingsRepository = SettingsRepository<PeekSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var list = new List<DashboardModuleItem>
            {
        ...
        {
            ISettingsRepository<PowerLauncherSettings> moduleSettingsRepository = SettingsRepository<PowerLauncherSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var list = new List<DashboardModuleItem>
            {
        ...
        {
            ISettingsRepository<WorkspacesSettings> moduleSettingsRepository = SettingsRepository<WorkspacesSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var settings = moduleSettingsRepository.SettingsConfig;
        ...
        {
            ISettingsRepository<MeasureToolSettings> moduleSettingsRepository = SettingsRepository<MeasureToolSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var list = new List<DashboardModuleItem>
            {
        ...
        {
            ISettingsRepository<ShortcutGuideSettings> moduleSettingsRepository = SettingsRepository<ShortcutGuideSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
        ...
        {
            ISettingsRepository<PowerOcrSettings> moduleSettingsRepository = SettingsRepository<PowerOcrSettings>.GetInstance(SettingsUtils.GlobalDefaultInstance);
            var list = new List<DashboardModuleItem>
            {
