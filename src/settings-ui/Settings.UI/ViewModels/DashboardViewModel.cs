...
namespace Microsoft.PowerToys.Settings.UI.ViewModels
{
    public class DashboardViewModel : Observable
    {
        ...
        internal void DashboardListItemClick(object sender)
        {
            ...
            ModuleType tag = (ModuleType)button.Tag;

            Type type = null;
            switch (tag)
            {
                case ModuleType.AlwaysOnTop: type = typeof(AlwaysOnTopPage); break;
                case ModuleType.Awake: type = typeof(AwakePage); break;
                case ModuleType.ColorPicker: type = typeof(ColorPickerPage); break;
                case ModuleType.CropAndLock: type = typeof(CropAndLockPage); break;
                case ModuleType.EnvironmentVariables: type = typeof(EnvironmentVariablesPage); break;
                case ModuleType.FancyZones: type = typeof(FancyZonesPage); break;
                case ModuleType.FileLocksmith: type = typeof(FileLocksmithPage); break;
                case ModuleType.FindMyMouse: type = typeof(MouseUtilsPage); break;
                case ModuleType.Hosts: type = typeof(HostsPage); break;
                case ModuleType.ImageResizer: type = typeof(ImageResizerPage); break;
                case ModuleType.KeyboardManager: type = typeof(KeyboardManagerPage); break;
                case ModuleType.MouseHighlighter: type = typeof(MouseUtilsPage); break;
                case ModuleType.MouseJump: type = typeof(MouseUtilsPage); break;
                case ModuleType.MousePointerCrosshairs: type = typeof(MouseUtilsPage); break;
                case ModuleType.MouseWithoutBorders: type = typeof(MouseWithoutBordersPage); break;
                case ModuleType.PastePlain: type = typeof(PastePlainPage); break;
                case ModuleType.Peek: type = typeof(PeekPage); break;
                case ModuleType.PowerRename: type = typeof(PowerRenamePage); break;
                case ModuleType.PowerLauncher: type = typeof(PowerLauncherPage); break;
                case ModuleType.PowerAccent: type = typeof(PowerAccentPage); break;
                case ModuleType.RegistryPreview: type = typeof(RegistryPreviewPage); break;
                case ModuleType.MeasureTool: type = typeof(MeasureToolPage); break;
                case ModuleType.ShortcutGuide: type = typeof(ShortcutGuidePage); break;
                case ModuleType.PowerOCR: type = typeof(PowerOcrPage); break;
            }
