...
|----------------|----------|-------------|
| Per user - x64       | [PowerToysUserSetup-0.86.0-x64.exe][ptUserX64] |  |
| Per user - ARM64     | [PowerToysUserSetup-0.86.0-arm64.exe][ptUserArm64] |  |
| Machine wide - x64   | [PowerToysSetup-0.86.0-x64.exe][ptMachineX64] |  |
| Machine wide - ARM64 | [PowerToysSetup-0.86.0-arm64.exe][ptMachineArm64] |  |
