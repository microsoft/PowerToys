...
- Now up to 4 modifier keys can be used in shortcuts.
...
- The Services plugin is able to search for parts of the name, display name or result type. Thanks [@htcfreek](https://github.com/htcfreek)!
