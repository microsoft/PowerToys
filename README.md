...
Go to the [PowerToys GitHub releases](https://aka.ms/installPowerToys) page, scroll down and select **Assets** to reveal the installation files, and choose the one that matches your architecture and install scope. For most devices, that would be _x64 per-user_.
</details>
