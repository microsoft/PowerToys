...
- Select **Ctrl** + **,** (comma) to open Command Palette settings from anywhere. Thanks [@jiripolasek](https://github.com/jiripolasek)!
- You can select **Page Up** and **Page Down** to navigate the list while focus is in the search box. Thanks [@samrueby](https://github.com/samrueby)!
