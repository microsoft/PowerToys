...
### Via GitHub with EXE [Recommended]
 ...
 - **For x64 processors (most common):** click on [PowerToysSetup-0.61.1-x64.exe](https://github.com/microsoft/PowerToys/releases/download/v0.61.0/PowerToysSetup-0.61.1-x64.exe)
 - **For ARM64 processors:** [PowerToysSetup-0.61.1-arm64.exe](https://github.com/microsoft/PowerToys/releases/download/v0.61.0/PowerToysSetup-0.61.0-arm64.exe)
