...
void ReportGPOValues(const std::filesystem::path& tmpDir)
{
    ...
    report << "getConfiguredNewPlusHideTemplateFilenameExtension: " << gpo_rule_configured_to_string(powertoys_gpo::getConfiguredNewPlusHideTemplateFilenameExtension()) << std::endl;
}
