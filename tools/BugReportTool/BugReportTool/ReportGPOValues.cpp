...
void ReportGPOValues(const std::filesystem::path& tmpDir)
{
    ...
    report << "getConfiguredAdvancedPasteAIFeatureEnabledValue: " << gpo_rule_configured_to_string(powertoys_gpo::getConfiguredAdvancedPasteAIFeatureEnabledValue()) << std::endl;
}
