...
- The candidate is not explicitly a preview release on the preview channel.
...
The directory must contain the build context, baseline, delta JSON, normalized PR data, release notes, release manifest, asset manifest, hashes, and final review report described by the skill.
