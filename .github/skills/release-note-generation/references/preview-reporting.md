...
Use explicit PASS, WARNING, or FAILURE wording. A successful run ends with a complete draft ready for human review. A failed run identifies the terminal safety gate and must not imply that a usable draft exists.
