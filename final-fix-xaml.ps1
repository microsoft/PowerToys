# Final fix for XAML files - remove all AutomationProperties.AutomationId and add them properly
...
foreach ($file in $xamlFiles) {
    ...
    # Remove ALL existing AutomationProperties.AutomationId entries
