...
## Plugins
###Executable actions
Invoke-Expression -Command "$PSScriptRoot\generateFileList.ps1 -fileDepsJson ""$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\ExecutableActions\PowerToys.FileActionsMenu.Plugins.ExecutableActions.deps.json"" -fileListName executableActionsComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs -isLauncherPlugin 1"
...
Invoke-Expression -Command "$PSScriptRoot\generateFileList.ps1 -fileDepsJson ""$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\FileContentActions\PowerToys.FileActionsMenu.Plugins.FileContentActions.deps.json"" -fileListName fileContentActionsComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs -isLauncherPlugin 1"
...
###File properties
Invoke-Expression -Command "$PSScriptRoot\generateFileList.ps1 -fileDepsJson ""$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\FileProperties\PowerToys.FileActionsMenu.Plugins.FileProperties.deps.json"" -fileListName filePropertiesComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs -isLauncherPlugin 1"
...
###Hashes
Invoke-Expression -Command "$PSScriptRoot\generateFileList.ps1 -fileDepsJson ""$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\Hashes\PowerToys.FileActionsMenu.Plugins.Hashes.deps.json"" -fileListName hashesComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs -isLauncherPlugin 1"
...
###Move Copy actions
Invoke-Expression -Command "$PSScriptRoot\generateFileList.ps1 -fileDepsJson ""$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\MoveCopyActions\PowerToys.FileActionsMenu.Plugins.MoveCopyActions.deps.json"" -fileListName moveCopyActionsComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs -isLauncherPlugin 1"
...
###Path copy
Invoke-Expression -Command "$PSScriptRoot\generateFileList.ps1 -fileDepsJson ""$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\PathCopy\PowerToys.FileActionsMenu.Plugins.PathCopy.deps.json"" -fileListName pathCopyComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs -isLauncherPlugin 1"
...
###PowerToys
Invoke-Expression -Command "$PSScriptRoot\generateFileList.ps1 -fileDepsJson ""$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\PowerToys\PowerToys.FileActionsMenu.Plugins.PowerToys.deps.json"" -fileListName powerToysComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs -isLauncherPlugin 1"
