...
## Plugins
###Executable actions
Generate-FileList -fileDepsJson "$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\ExecutableActions\PowerToys.FileActionsMenu.Plugins.ExecutableActions.deps.json" -fileListName executableActionsComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs
...
Generate-FileList -fileDepsJson "$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\FileContentActions\PowerToys.FileActionsMenu.Plugins.FileContentActions.deps.json" -fileListName fileContentActionsComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs
...
###File properties
Generate-FileList -fileDepsJson "$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\FileProperties\PowerToys.FileActionsMenu.Plugins.FileProperties.deps.json" -fileListName filePropertiesComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs
...
###Hashes
Generate-FileList -fileDepsJson "$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\Hashes\PowerToys.FileActionsMenu.Plugins.Hashes.deps.json" -fileListName hashesComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs
...
Generate-FileList -fileDepsJson "$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\ImageClipboardActions\PowerToys.FileActionsMenu.Plugins.ImageClipboardActions.deps.json" -fileListName imageClipboardActionsComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs
...
###Move Copy actions
Generate-FileList -fileDepsJson "$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\MoveCopyActions\PowerToys.FileActionsMenu.Plugins.MoveCopyActions.deps.json" -fileListName moveCopyActionsComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs
...
###Path copy
Generate-FileList -fileDepsJson "$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\PathCopy\PowerToys.FileActionsMenu.Plugins.PathCopy.deps.json" -fileListName pathCopyComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs
...
###PowerToys
Generate-FileList -fileDepsJson "$PSScriptRoot..\..\..\$platform\Release\FileActionsMenuPlugins\PowerToys\PowerToys.FileActionsMenu.Plugins.PowerToys.deps.json" -fileListName powerToysComponentFiles -wxsFilePath $PSScriptRoot\FileActionsMenu.wxs
