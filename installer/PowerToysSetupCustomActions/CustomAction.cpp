...
UINT __stdcall UnRegisterContextMenuPackagesCA(MSIHANDLE hInstall)
{
    ...
    try
    {
        ...
        const std::vector<std::wstring> packagesToRemoveDisplayName{ { L"PowerRenameContextMenu" }, { L"ImageResizerContextMenu" }, { L"FileLocksmithContextMenu" }, { L"NewPlus.ShellExtension" } };
