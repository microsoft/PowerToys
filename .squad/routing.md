...
|-----------|----------|----------|
| CmdPal UI, XAML, pages, controls, styles | Trinity | MainWindow.xaml, pages, converters, ExtViews, Dock UI, toast UI |
| CmdPal ViewModels, services, MVVM | Morpheus | *ViewModel.cs, services, models, AppStateModel, TopLevelCommandManager |
| Extensions SDK, C++/WinRT, ext/* | Tank | extensionsdk/, ext/Microsoft.CmdPal.Ext.*, CmdPalKeyboardService, Microsoft.Terminal.UI |
| Architecture, code review, decisions | Neo | Cross-cutting changes, IPC, design review, PR review |
| Testing, quality, coverage | Oracle | Tests/*, unit tests, UI tests, extension test base |
...
| WinUI 3, XAML, controls | Trinity | — |
| C# MVVM, services | Morpheus | — |
| SDK, C++/WinRT, extensions | Tank | — |
| Tests, quality, coverage | Oracle | — |
