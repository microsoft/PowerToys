...
|-----------|----------|----------|
| UI / XAML / Views / ViewModels | Scarlett | Build pages, fix layout, theme changes, data binding |
| Extensions / SDK / C++ interop | Snake Eyes | New extension, SDK changes, built-in extension work, C++ native layer |
| Architecture / design / review | Duke | Design proposals, code review, cross-component changes |
| Code review | Duke | Review PRs, check quality, suggest improvements |
| Testing | Hawk | Write tests, find edge cases, verify fixes |
