...
## Crop And Lock
 * Thumbnail mode
   - [x] 1. Test with win32 app
   - [x] 2. Test with packaged app
...
Find My Mouse:
  ...
  * Test the different settings and verify they apply:
    ...
    - [x] 12. Spotlight radius
          - TestMethod("MouseUtils.FindMyMouse.FindMyMouseDifferentSettings")
    - [x] 13. Spotlight initial zoom (1x vs 9x will show the difference)
    - [x] 14. Animation duration
    - [x] 15. Change activation method to shake and activate by shaking your mouse pointer
    - [x] 16. Excluded apps
 ...
 * Run PowerToys as user:
   - [x] 1. Verify `Win + Shift + /` opens the guide
   - [x] 2. Change the hotkey to a different shortcut (e.g. `Win + /`) and verify it works
   - [x] 3. Set Shortcut Guide to start with a Windows key press and verify it works.
 * Restore the `Win + Shift + /` hotkey.
   - [x] 4. Open the guide and close it pressing `Esc`
   - [x] 5. Open the guide and close it pressing and releasing the `Win` key
 * With PowerToys running as a user, open an elevated app and keep it on foreground:
   - [x] 6. Verify `Win + Shift + /` opens the guide
   - [x] 7. Verify some of the shortcuts shown in the guide work and the guide is closed when pressed

## [ZoomIt](tests-checklist-template-zoomit-section.md)

 * Enable ZoomIt in Settings.
   - [x] 1. Verify ZoomIt tray icon appears in the tray icons, and that when you left-click or right-click, it just shows the 4 action entries: "Break Timer", "Draw", "Zoom" and "Record".
   - [x] 2. Turn the "Show tray icon" option off and verify the tray icon is gone.
   - [x] 3. Turn the "Show tray icon" option on and verify the tray icon is back.
 * Test the base modes through a shortcuts:
   - [x] 4. Press the Zoom Toggle Hotkey and verify ZoomIt zooms in on the mouse. You can exit Zoom by pressing Escape or the Hotkey again.
   - [x] 5. Press the Live Zoom Toggle Hotkey and verify ZoomIt zooms in on the mouse, while the screen still updates instead of showing a still image. You can exit Live Zoom by pressing the Hotkey again.
   - [x] 6. Press the Draw without Zoom Hotkey and verify you can draw. You can leave this mode by pressing the Escape.
   - [x] 7. Select a text file as the Input file for Demo Type, focus notepad and press the Demo Type hotkey. It should start typing the text file. You can exit Demo Type by pressing Escape.
   - [x] 8. Press the Start Break Timer Hotkey and verify it starts the Timer. You can exit by pressing Escape.
   - [x] 9. Press the Record Toggle Hotkey to start recording a screen. Press the Record Toggle Hotkey again to exit the mode and save the recording to a file.
   - [x] 10. Press the Snip Toggle Hotkey to take a snip of the screen. Paste it to Paint to verify a snip was taken.
 * Test some Settings to verify the types are being passed correctly to ZoomIt:
   - [X] 11. Change the "Animate zoom in and zoom out" setting and activate Zoom mode to verify it applies.
   - [X] 12. Change the "Specify the initial level of magnification when zooming in" and activate Zoom mode to verify it applies.
   - [X] 13. Change the Type Font to another font. Enter Break mode to quickly verify the font changed.
   - [x] 14. Change the Demo Type typing speed and verify the change applies.
   - [x] 15. Change the timer Opacity for Break mode and verify that the change applies.
   - [x] 16. Change the timer Position for Break mode and verify that the change applies.
   - [x] 17. Select a Background Image file as background for Break mode and verify that the change applies.
   - [x] 18. Turn on "Play Sound on Expiration", select a sound file, aset the timer to 1 minute, activate the Break Mode and verify the sound plays after 1 minute. (Alarm1.wav from "C:\Windows\Media" should be long enough to notice)
   - [x] 19. Open the Microphone combo box in the Record section and verify it lists your microphones.
 * Test the tray icon actions:
   - [x] 20. Verify pressing "Break Timer" enters Break mode.
   - [x] 21. Verify pressing "Draw" enters Draw mode.
   - [x] 22. Verify pressing "Zoom" enters Zoom mode.
   - [x] 23. Verify pressing "Record" enters Record mode.
