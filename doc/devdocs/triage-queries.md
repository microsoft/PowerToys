...
- [Catch all](https://watsonportal.microsoft.com/CabSearch?=&DateTimeFormat=UTC&MaxRows=1000&AppScope_AppVersion=0.72.0.0&Process=*powertoys*)

### EXE name

- [EXE installer](https://watsonportal.microsoft.com/Application?DateRange=Last%2014%20Days&MaxRows=100&AppScope_AppName=PowerToysSetup-0.72.0-x64.exe)
- [Main exe](https://watsonportal.microsoft.com/Application?DateRange=Last%2014%20Days&MaxRows=100&AppScope_AppVersion=0.72.0&AppScope_AppName=PowerToys.exe)
- [PT Run / example](https://watsonportal.microsoft.com/Application?DateRange=Last%2014%20Days&MaxRows=100&AppScope_AppVersion=0.72.0&AppScope_AppName=PowerToys.PowerLauncher.exe)
