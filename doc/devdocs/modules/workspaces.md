...
parsing, package policy combinations, and registration identity changes.
Dedicated native launcher pipe-transport tests are temporarily excluded while
their test-host shutdown issue is investigated in the diagnostic branch; this
does not change the production IPC implementation.
Reproducible harmless unsigned/self-signed/tampered test applications
