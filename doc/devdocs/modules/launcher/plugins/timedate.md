...
- We have the following settings that the user can configure to change the behavior of the plugin:
	...
	|--------------|-----------|------------|------------|
	| `CalendarFirstWeekRule` | Combo box | `Use system settings (-1)` | First week of the year | Configure the calendar rule for the first week of the year. |
	| `FirstDayOfWeek` | Combo box | `Use system settings (-1)` | First day of week | |
