...
- Begin maintaining a public product roadmap 
- Users are always on the latest
- Transparency report on telemetry
- Workflow for how items are reviewed, processed
- Workflow for how we build and ship

#### P1 (want)

- All shipping utilities have automated unit tests
...
- All strings are localized for shipping utilities
