...
- **Display Management**: Re-enabled the PowerDisplay module with a new icon, DPI fixes, UI/UX improvements, and installer integration
...
- **Settings**: Fixed arrow key icons rendering as box placeholders by switching to standard Unicode arrow characters
