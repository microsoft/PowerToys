...
## Command Palette
 ...
 - Added plain text viewer and image viewer content types for extensions, enabling display of raw text and zoomable images directly in the content pane in [#43964](https://github.com/microsoft/PowerToys/pull/43964). Thanks [@jiripolasek](https://github.com/jiripolasek)!
...
## Settings
 ...
 - Refreshed Settings UI assets and copy by fixing a ZoomIt page regression, updating the Command Palette page with current links and screenshots, swapping New+ imagery to match other modules, and adding missing overview screenshots in [#47132](https://github.com/microsoft/PowerToys/pull/47132).
...
### Tests
 ...
 - Fixed MSTEST0017 analyzer warnings by correcting the argument order in 22 Assert calls across 8 test files to follow the MSTest convention of Assert.AreEqual(expected, actual) in [#46712](https://github.com/microsoft/PowerToys/pull/46712).
 - Added comprehensive unit tests for Hosts ValidationHelper (IPv4, IPv6, hostname validation with max-count boundary) and ColorPicker format conversions (CMYK, HSB, HSI, HWB, CIE XYZ/LAB, Oklab, Oklch, sRGB-linear, NCol) in [#46679](https://github.com/microsoft/PowerToys/pull/46679).
